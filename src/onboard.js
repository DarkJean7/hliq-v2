...
window.__openFundGuide = function() {
  ...
  _sheet(`<div style="font-size:19px;font-weight:800;margin-bottom:4px">${T('Fund your account', 'Financia tu cuenta')} 💰</div>
    ...
    ${step(1, T('Get a crypto wallet', 'Consigue una billetera cripto'), T('Install a self-custody wallet — <b>Uniswap Wallet</b> on mobile, or <b>Rabby</b> / <b>MetaMask</b> on desktop. It holds your funds and only you control it.', 'Instala una billetera de autocustodia — <b>Uniswap Wallet</b> en el móvil, o <b>Rabby</b> / <b>MetaMask</b> en escritorio. Guarda tus fondos y solo tú la controlas.'))}
