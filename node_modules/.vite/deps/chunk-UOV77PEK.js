...
// node_modules/@reown/appkit-controllers/node_modules/ox/node_modules/@noble/curves/esm/abstract/utils.js
var _0n2 = BigInt(0);
var _1n2 = BigInt(1);
function isBytes2(a) {
  return a instanceof Uint8Array || ArrayBuffer.isView(a) && a.constructor.name === "Uint8Array";
...
// node_modules/@reown/appkit-controllers/node_modules/ox/_esm/core/AbiError.js
...
// node_modules/@reown/appkit-controllers/node_modules/ox/node_modules/@noble/curves/esm/abstract/modular.js
var _0n3 = BigInt(0);
var _1n3 = BigInt(1);
var _2n2 = BigInt(2);
var _3n = BigInt(3);
...
// node_modules/@reown/appkit-controllers/node_modules/ox/node_modules/@noble/curves/esm/abstract/curve.js
var _0n4 = BigInt(0);
var _1n4 = BigInt(1);
...
// node_modules/@reown/appkit-controllers/node_modules/ox/node_modules/@noble/curves/esm/abstract/weierstrass.js
...
function weierstrassPoints(opts) {
  ...
  class Point2 {
     ...
     */
    static fromHex(hex) {
      const P2 = Point2.fromAffine(fromBytes3(ensureBytes("pointHex", hex)));
      P2.assertValidity();
      return P2;
    }
...
function weierstrass(curveDef) {
  ...
  const slcNum = (b, from9, to) => bytesToNumberBE(b.slice(from9, to));
  class Signature {
...
// node_modules/@reown/appkit-controllers/node_modules/ox/node_modules/@noble/curves/esm/_shortw_utils.js
...
// node_modules/@reown/appkit-controllers/node_modules/ox/node_modules/@noble/curves/esm/abstract/hash-to-curve.js
...
function hash_to_field(msg, count, options) {
  ...
  const { p, k, m: m2, hash, expand, DST: _DST } = options;
  abytes2(msg);
  anum(count);
...
// node_modules/@reown/appkit-controllers/node_modules/ox/node_modules/@noble/curves/esm/secp256k1.js
...
function schnorrSign(message, privateKey, auxRand = randomBytes(32)) {
  ...
  const t = numTo32b(d3 ^ num(taggedHash("BIP0340/aux", a)));
  ...
  sig.set(rx, 0);
  sig.set(numTo32b(modN(k + e * d3)), 32);
...
// node_modules/@reown/appkit-controllers/node_modules/ox/_esm/core/internal/base58.js
...
// node_modules/@reown/appkit-controllers/node_modules/ox/_esm/core/Base64.js
...
// node_modules/@reown/appkit-controllers/node_modules/@noble/hashes/esm/_blake.js
...
// node_modules/@reown/appkit-controllers/node_modules/@noble/hashes/esm/blake2.js
...
var BLAKE2s = class extends BLAKE2 {
  ...
  compress(msg, offset, isLast) {
    ...
    const { v0, v1, v2, v3, v4, v5, v6, v7, v8, v9, v10, v11, v12, v13, v14, v15 } = compress(BSIGMA, offset, msg, 10, this.v0, this.v1, this.v2, this.v3, this.v4, this.v5, this.v6, this.v7, B2S_IV[0], B2S_IV[1], B2S_IV[2], B2S_IV[3], l2 ^ B2S_IV[4], h3 ^ B2S_IV[5], isLast ? ~B2S_IV[6] : B2S_IV[6], B2S_IV[7]);
    this.v0 ^= v0 ^ v8;
    this.v1 ^= v1 ^ v9;
    this.v2 ^= v2 ^ v10;
    this.v3 ^= v3 ^ v11;
...
// node_modules/@reown/appkit-controllers/node_modules/@noble/hashes/esm/blake3.js
var B3_Flags = {
  CHUNK_START: 1,
  CHUNK_END: 2,
  PARENT: 4,
...
var BLAKE3 = class _BLAKE3 extends BLAKE2 {
  ...
  b2Compress(counter, flags, buf, bufPos = 0) {
    ...
    const { v0, v1, v2, v3, v4, v5, v6, v7, v8, v9, v10, v11, v12, v13, v14, v15 } = compress(B3_SIGMA, bufPos, buf, 7, s[0], s[1], s[2], s[3], s[4], s[5], s[6], s[7], B3_IV[0], B3_IV[1], B3_IV[2], B3_IV[3], h3, l2, pos, flags);
    s[0] = v0 ^ v8;
    s[1] = v1 ^ v9;
    s[2] = v2 ^ v10;
    s[3] = v3 ^ v11;
  ...
  b2CompressOut() {
    ...
    swap32IfBE(buffer32);
    const { v0, v1, v2, v3, v4, v5, v6, v7, v8, v9, v10, v11, v12, v13, v14, v15 } = compress(B3_SIGMA, 0, buffer32, 7, s[0], s[1], s[2], s[3], s[4], s[5], s[6], s[7], B3_IV[0], B3_IV[1], B3_IV[2], B3_IV[3], l2, h3, pos, flags);
    out32[0] = v0 ^ v8;
    out32[1] = v1 ^ v9;
    out32[2] = v2 ^ v10;
    out32[3] = v3 ^ v11;
...
// node_modules/@reown/appkit-controllers/node_modules/ox/_esm/core/Blobs.js
...
// node_modules/@reown/appkit-controllers/node_modules/ox/node_modules/@noble/curves/esm/abstract/bls.js
var _0n7 = BigInt(0);
var _1n7 = BigInt(1);
var _2n5 = BigInt(2);
var _3n3 = BigInt(3);
...
// node_modules/@reown/appkit-controllers/node_modules/ox/node_modules/@noble/curves/esm/abstract/tower.js
var _0n8 = BigInt(0);
var _1n8 = BigInt(1);
var _2n6 = BigInt(2);
var _3n4 = BigInt(3);
...
function psiFrobenius(Fp4, Fp22, base2) {
  const PSI_X = Fp22.pow(base2, (Fp4.ORDER - _1n8) / _3n4);
  const PSI_Y = Fp22.pow(base2, (Fp4.ORDER - _1n8) / _2n6);
  function psi(x2, y2) {
    const x22 = Fp22.mul(Fp22.frobeniusMap(x2, 1), PSI_X);
    const y22 = Fp22.mul(Fp22.frobeniusMap(y2, 1), PSI_Y);
    return [x22, y22];
  }
  const PSI2_X = Fp22.pow(base2, (Fp4.ORDER ** _2n6 - _1n8) / _3n4);
  const PSI2_Y = Fp22.pow(base2, (Fp4.ORDER ** _2n6 - _1n8) / _2n6);
...
function tower12(opts) {
  ...
  const Fp22 = {
    ...
    sqrt: (num2) => {
      ...
      let d3 = Fp4.mul(Fp4.add(a, c0), Fpdiv2);
      const legendre = FpLegendre(Fp4, d3);
      if (legendre === -1)
        d3 = Fp4.sub(d3, a);
      const a0 = Fp4.sqrt(d3);
...
// node_modules/@reown/appkit-controllers/node_modules/ox/node_modules/@noble/curves/esm/bls12-381.js
var _0n9 = BigInt(0);
var _1n9 = BigInt(1);
var _2n7 = BigInt(2);
var _3n5 = BigInt(3);
...
// node_modules/@reown/appkit-controllers/node_modules/ox/node_modules/@noble/curves/esm/abstract/edwards.js
var _0n10 = BigInt(0);
var _1n10 = BigInt(1);
var _2n8 = BigInt(2);
var _8n2 = BigInt(8);
...
// node_modules/@reown/appkit-controllers/node_modules/ox/node_modules/@noble/curves/esm/abstract/montgomery.js
var _0n11 = BigInt(0);
var _1n11 = BigInt(1);
var _2n9 = BigInt(2);
...
function montgomery(curveDef) {
  ...
  const { P: P2, type, adjustScalarBytes: adjustScalarBytes2, powPminus2 } = CURVE;
...
// node_modules/@reown/appkit-controllers/node_modules/ox/node_modules/@noble/curves/esm/ed25519.js
...
function calcElligatorRistrettoMap(r0) {
  ...
  let c = BigInt(-1);
  const D = mod2((c - d3 * r2) * mod2(r2 + d3));
...
// node_modules/@reown/appkit-controllers/node_modules/@adraffy/ens-normalize/dist/index.mjs
var S0 = 44032;
var L0 = 4352;
var V0 = 4449;
var T0 = 4519;
...
// node_modules/@reown/appkit-controllers/node_modules/ox/node_modules/@noble/curves/esm/nist.js
...
// node_modules/@reown/appkit-controllers/node_modules/ox/node_modules/@noble/curves/esm/p256.js
var hashToCurve3 = (() => p256_hasher.hashToCurve)();
var encodeToCurve3 = (() => p256_hasher.encodeToCurve)();

// node_modules/@reown/appkit-controllers/node_modules/ox/_esm/core/RpcResponse.js
...
// node_modules/@reown/appkit-controllers/node_modules/ox/_esm/core/Provider.js
...
// node_modules/@reown/appkit-controllers/node_modules/ox/_esm/core/WebAuthnP256.js
...
function base(ALPHABET2) {
  ...
  function encode4(source) {
    ...
    while (pbegin !== pend) {
      ...
      let i2 = 0;
      for (let it1 = size3 - 1; (carry !== 0 || i2 < length) && it1 !== -1; it1--, i2++) {
        carry += 256 * b58[it1] >>> 0;
  ...
  function decodeUnsafe(source) {
    ...
    while (psz < source.length) {
      ...
      let i2 = 0;
      for (let it3 = size3 - 1; (carry !== 0 || i2 < length) && it3 !== -1; it3--, i2++) {
...
// node_modules/@reown/appkit-controllers/node_modules/@msgpack/msgpack/dist.esm/utils/utf8.mjs
...
// node_modules/@reown/appkit-controllers/node_modules/@msgpack/msgpack/dist.esm/ExtData.mjs
var ExtData = class {
...
// node_modules/@reown/appkit-controllers/node_modules/@msgpack/msgpack/dist.esm/DecodeError.mjs
...
// node_modules/@reown/appkit-controllers/node_modules/@msgpack/msgpack/dist.esm/utils/int.mjs
...
// node_modules/@reown/appkit-controllers/node_modules/@msgpack/msgpack/dist.esm/timestamp.mjs
var EXT_TIMESTAMP = -1;
...
// node_modules/@reown/appkit-controllers/node_modules/@msgpack/msgpack/dist.esm/ExtensionCodec.mjs
...
// node_modules/@reown/appkit-controllers/node_modules/@msgpack/msgpack/dist.esm/CachedKeyDecoder.mjs
...
// node_modules/@reown/appkit-controllers/node_modules/@msgpack/msgpack/dist.esm/Decoder.mjs
...
var hc = class extends qr {
  ...
  process(e, n2) {
    ...
    for (let l2 = 0; l2 < 64; l2++) {
      const d3 = bt(c, 6) ^ bt(c, 11) ^ bt(c, 25), h3 = a + d3 + uc(c, f4, u) + dc[l2] + $t[l2] | 0, m2 = (bt(r2, 2) ^ bt(r2, 13) ^ bt(r2, 22)) + lc(r2, o2, s) | 0;
...
var dn = class extends qr {
  ...
  get() {
    const { Ah: e, Al: n2, Bh: r2, Bl: o2, Ch: s, Cl: i2, Dh: c, Dl: f4, Eh: u, El: a, Fh: l2, Fl: d3, Gh: h3, Gl: y2, Hh: m2, Hl: w } = this;
    return [e, n2, r2, o2, s, i2, c, f4, u, a, l2, d3, h3, y2, m2, w];
  }
  set(e, n2, r2, o2, s, i2, c, f4, u, a, l2, d3, h3, y2, m2, w) {
    this.Ah = e | 0, this.Al = n2 | 0, this.Bh = r2 | 0, this.Bl = o2 | 0, this.Ch = s | 0, this.Cl = i2 | 0, this.Dh = c | 0, this.Dl = f4 | 0, this.Eh = u | 0, this.El = a | 0, this.Fh = l2 | 0, this.Fl = d3 | 0, this.Gh = h3 | 0, this.Gl = y2 | 0, this.Hh = m2 | 0, this.Hl = w | 0;
  }
  process(e, n2) {
    ...
    let { Ah: r2, Al: o2, Bh: s, Bl: i2, Ch: c, Cl: f4, Dh: u, Dl: a, Eh: l2, El: d3, Fh: h3, Fl: y2, Gh: m2, Gl: w, Hh: U, Hl: F } = this;
    for (let R2 = 0; R2 < 80; R2++) {
      const Z = St(l2, d3, 14) ^ St(l2, d3, 18) ^ de(l2, d3, 41), H = Ot(l2, d3, 14) ^ Ot(l2, d3, 18) ^ he(l2, d3, 41), j2 = l2 & h3 ^ ~l2 & m2, L = d3 & y2 ^ ~d3 & w, k = zi(F, H, L, gc[R2], Ct[R2]), O3 = Yi(k, U, Z, j2, pc[R2], Tt[R2]), T = k | 0, C3 = St(r2, o2, 28) ^ de(r2, o2, 34) ^ de(r2, o2, 39), _ = Ot(r2, o2, 28) ^ he(r2, o2, 34) ^ he(r2, o2, 39), p = r2 & s ^ r2 & c ^ s & c, b = o2 & i2 ^ o2 & f4 ^ i2 & f4;
      U = m2 | 0, F = w | 0, m2 = h3 | 0, w = y2 | 0, h3 = l2 | 0, y2 = d3 | 0, { h: l2, l: d3 } = dt(u | 0, a | 0, O3 | 0, T | 0), u = c | 0, a = f4 | 0, c = s | 0, f4 = i2 | 0, s = r2 | 0, i2 = o2 | 0;
      const g = fn(T, _, b);
      r2 = an(g, O3, C3, p), o2 = g | 0;
    }
    ({ h: r2, l: o2 } = dt(this.Ah | 0, this.Al | 0, r2 | 0, o2 | 0)), { h: s, l: i2 } = dt(this.Bh | 0, this.Bl | 0, s | 0, i2 | 0), { h: c, l: f4 } = dt(this.Ch | 0, this.Cl | 0, c | 0, f4 | 0), { h: u, l: a } = dt(this.Dh | 0, this.Dl | 0, u | 0, a | 0), { h: l2, l: d3 } = dt(this.Eh | 0, this.El | 0, l2 | 0, d3 | 0), { h: h3, l: y2 } = dt(this.Fh | 0, this.Fl | 0, h3 | 0, y2 | 0), { h: m2, l: w } = dt(this.Gh | 0, this.Gl | 0, m2 | 0, w | 0), { h: U, l: F } = dt(this.Hh | 0, this.Hl | 0, U | 0, F | 0), this.set(r2, o2, s, i2, c, f4, u, a, l2, d3, h3, y2, m2, w, U, F);
  }
  roundClean() {
    lt(Tt, Ct);
  }
...
function jt(t, e, n2, r2, o2, s) {
  ...
  let f4 = S[2 * t], u = S[2 * t + 1], a = S[2 * e], l2 = S[2 * e + 1], d3 = S[2 * n2], h3 = S[2 * n2 + 1], y2 = S[2 * r2], m2 = S[2 * r2 + 1], w = fn(f4, a, i2);
  u = an(w, u, l2, c), f4 = w | 0, { Dh: m2, Dl: y2 } = { Dh: m2 ^ u, Dl: y2 ^ f4 }, { Dh: m2, Dl: y2 } = { Dh: Di(m2, y2), Dl: Vi(m2) }, { h: h3, l: d3 } = dt(h3, d3, m2, y2), { Bh: l2, Bl: a } = { Bh: l2 ^ h3, Bl: a ^ d3 }, { Bh: l2, Bl: a } = { Bh: St(l2, a, 24), Bl: Ot(l2, a, 24) }, S[2 * t] = f4, S[2 * t + 1] = u, S[2 * e] = a, S[2 * e + 1] = l2, S[2 * n2] = d3, S[2 * n2 + 1] = h3, S[2 * r2] = y2, S[2 * r2 + 1] = m2;
}
function Lt(t, e, n2, r2, o2, s) {
  const i2 = o2[s], c = o2[s + 1];
  let f4 = S[2 * t], u = S[2 * t + 1], a = S[2 * e], l2 = S[2 * e + 1], d3 = S[2 * n2], h3 = S[2 * n2 + 1], y2 = S[2 * r2], m2 = S[2 * r2 + 1], w = fn(f4, a, i2);
  u = an(w, u, l2, c), f4 = w | 0, { Dh: m2, Dl: y2 } = { Dh: m2 ^ u, Dl: y2 ^ f4 }, { Dh: m2, Dl: y2 } = { Dh: St(m2, y2, 16), Dl: Ot(m2, y2, 16) }, { h: h3, l: d3 } = dt(h3, d3, m2, y2), { Bh: l2, Bl: a } = { Bh: l2 ^ h3, Bl: a ^ d3 }, { Bh: l2, Bl: a } = { Bh: de(l2, a, 63), Bl: he(l2, a, 63) }, S[2 * t] = f4, S[2 * t + 1] = u, S[2 * e] = a, S[2 * e + 1] = l2, S[2 * n2] = d3, S[2 * n2 + 1] = h3, S[2 * r2] = y2, S[2 * r2 + 1] = m2;
}
...
var Ic = class extends Bc {
  ...
  get() {
    let { v0l: e, v0h: n2, v1l: r2, v1h: o2, v2l: s, v2h: i2, v3l: c, v3h: f4, v4l: u, v4h: a, v5l: l2, v5h: d3, v6l: h3, v6h: y2, v7l: m2, v7h: w } = this;
    return [e, n2, r2, o2, s, i2, c, f4, u, a, l2, d3, h3, y2, m2, w];
  }
  set(e, n2, r2, o2, s, i2, c, f4, u, a, l2, d3, h3, y2, m2, w) {
    this.v0l = e | 0, this.v0h = n2 | 0, this.v1l = r2 | 0, this.v1h = o2 | 0, this.v2l = s | 0, this.v2h = i2 | 0, this.v3l = c | 0, this.v3h = f4 | 0, this.v4l = u | 0, this.v4h = a | 0, this.v5l = l2 | 0, this.v5h = d3 | 0, this.v6l = h3 | 0, this.v6h = y2 | 0, this.v7l = m2 | 0, this.v7h = w | 0;
  }
  compress(e, n2, r2) {
...
function lf(t, e, n2, r2, o2, s, i2, c) {
  const f4 = o2.length, u = new Uint8Array(Le), a = Pt(u), l2 = In(o2) && In(s), d3 = l2 ? Pt(o2) : vo, h3 = l2 ? Pt(s) : vo;
  for (let y2 = 0; y2 < f4; i2++) {
    ...
    if (l2 && m2 === Le) {
      ...
      for (let U = 0, F; U < uf; U++) F = w + U, h3[F] = d3[F] ^ a[U];
      y2 += Le;
      continue;
    }
...
function df(t, e) {
  ...
  return xn(o2), xn(i2), vn(s), vn(n2), (c, f4, u, a, l2 = 0) => {
    ot(c), ot(f4), ot(u);
    const d3 = u.length;
    if (a === void 0 && (a = new Uint8Array(d3)), ot(a), xn(l2), l2 < 0 || l2 >= wo) throw new Error("arx: counter overflow");
...
var hf = class {
  ...
  process(e, n2, r2 = false) {
    const o2 = r2 ? 0 : 2048, { h: s, r: i2 } = this, c = i2[0], f4 = i2[1], u = i2[2], a = i2[3], l2 = i2[4], d3 = i2[5], h3 = i2[6], y2 = i2[7], m2 = i2[8], w = i2[9], U = W(e, n2 + 0), F = W(e, n2 + 2), R2 = W(e, n2 + 4), Z = W(e, n2 + 6), H = W(e, n2 + 8), j2 = W(e, n2 + 10), L = W(e, n2 + 12), k = W(e, n2 + 14);
    ...
    v = B >>> 13, B &= 8191, B += b * (5 * d3) + g * (5 * l2) + x2 * (5 * a) + E * (5 * u) + I2 * (5 * f4), v += B >>> 13, B &= 8191;
    let A2 = v + O3 * f4 + T * c + C3 * (5 * w) + _ * (5 * m2) + p * (5 * y2);
    v = A2 >>> 13, A2 &= 8191, A2 += b * (5 * h3) + g * (5 * d3) + x2 * (5 * l2) + E * (5 * a) + I2 * (5 * u), v += A2 >>> 13, A2 &= 8191;
    let N2 = v + O3 * u + T * f4 + C3 * c + _ * (5 * w) + p * (5 * m2);
    v = N2 >>> 13, N2 &= 8191, N2 += b * (5 * y2) + g * (5 * h3) + x2 * (5 * d3) + E * (5 * l2) + I2 * (5 * a), v += N2 >>> 13, N2 &= 8191;
    let D = v + O3 * a + T * u + C3 * f4 + _ * c + p * (5 * w);
    v = D >>> 13, D &= 8191, D += b * (5 * m2) + g * (5 * y2) + x2 * (5 * h3) + E * (5 * d3) + I2 * (5 * l2), v += D >>> 13, D &= 8191;
    let P2 = v + O3 * l2 + T * a + C3 * u + _ * f4 + p * c;
    v = P2 >>> 13, P2 &= 8191, P2 += b * (5 * w) + g * (5 * m2) + x2 * (5 * y2) + E * (5 * h3) + I2 * (5 * d3), v += P2 >>> 13, P2 &= 8191;
    let $2 = v + O3 * d3 + T * l2 + C3 * a + _ * u + p * f4;
    v = $2 >>> 13, $2 &= 8191, $2 += b * c + g * (5 * w) + x2 * (5 * m2) + E * (5 * y2) + I2 * (5 * h3), v += $2 >>> 13, $2 &= 8191;
    let V2 = v + O3 * h3 + T * d3 + C3 * l2 + _ * a + p * u;
    v = V2 >>> 13, V2 &= 8191, V2 += b * f4 + g * c + x2 * (5 * w) + E * (5 * m2) + I2 * (5 * y2), v += V2 >>> 13, V2 &= 8191;
    let q2 = v + O3 * y2 + T * h3 + C3 * d3 + _ * l2 + p * a;
    v = q2 >>> 13, q2 &= 8191, q2 += b * u + g * f4 + x2 * c + E * (5 * w) + I2 * (5 * m2), v += q2 >>> 13, q2 &= 8191;
    let G = v + O3 * m2 + T * y2 + C3 * h3 + _ * d3 + p * l2;
    v = G >>> 13, G &= 8191, G += b * a + g * u + x2 * f4 + E * c + I2 * (5 * w), v += G >>> 13, G &= 8191;
    let M2 = v + O3 * w + T * m2 + C3 * y2 + _ * h3 + p * d3;
...
function bf(t, e, n2, r2, o2, s = 20) {
  let i2 = t[0], c = t[1], f4 = t[2], u = t[3], a = e[0], l2 = e[1], d3 = e[2], h3 = e[3], y2 = e[4], m2 = e[5], w = e[6], U = e[7], F = o2, R2 = n2[0], Z = n2[1], H = n2[2], j2 = i2, L = c, k = f4, O3 = u, T = a, C3 = l2, _ = d3, p = h3, b = y2, g = m2, x2 = w, E = U, I2 = F, v = R2, B = Z, A2 = H;
  ...
  let N2 = 0;
  r2[N2++] = i2 + j2 | 0, r2[N2++] = c + L | 0, r2[N2++] = f4 + k | 0, r2[N2++] = u + O3 | 0, r2[N2++] = a + T | 0, r2[N2++] = l2 + C3 | 0, r2[N2++] = d3 + _ | 0, r2[N2++] = h3 + p | 0, r2[N2++] = y2 + b | 0, r2[N2++] = m2 + g | 0, r2[N2++] = w + x2 | 0, r2[N2++] = U + E | 0, r2[N2++] = F + I2 | 0, r2[N2++] = R2 + v | 0, r2[N2++] = Z + B | 0, r2[N2++] = H + A2 | 0;
}
...
function Ht(t, e, n2 = false, r2 = {}) {
  ...
  let a;
  const l2 = Object.freeze({ ORDER: t, isLE: n2, BITS: f4, BYTES: u, MASK: me(f4), ZERO: st, ONE: nt, allowedLengths: c, create: (d3) => ct(d3, t), isValid: (d3) => {
    if (typeof d3 != "bigint") throw new Error("invalid field element: expected bigint, got " + typeof d3);
    return st <= d3 && d3 < t;
  }, is0: (d3) => d3 === st, isValidNot0: (d3) => !l2.is0(d3) && l2.isValid(d3), isOdd: (d3) => (d3 & nt) === nt, neg: (d3) => ct(-d3, t), eql: (d3, h3) => d3 === h3, sqr: (d3) => ct(d3 * d3, t), add: (d3, h3) => ct(d3 + h3, t), sub: (d3, h3) => ct(d3 - h3, t), mul: (d3, h3) => ct(d3 * h3, t), pow: (d3, h3) => Tf(l2, d3, h3), div: (d3, h3) => ct(d3 * Co(h3, t), t), sqrN: (d3) => d3 * d3, addN: (d3, h3) => d3 + h3, subN: (d3, h3) => d3 - h3, mulN: (d3, h3) => d3 * h3, inv: (d3) => Co(d3, t), sqrt: s || ((d3) => (a || (a = _f(t)), a(l2, d3))), toBytes: (d3) => n2 ? Un(d3, u) : Nn(d3, u), fromBytes: (d3, h3 = true) => {
    if (c) {
    ...
    return y2;
  }, invertBatch: (d3) => ko(l2, d3), cmov: (d3, h3, y2) => y2 ? h3 : d3 });
...
var kf = class {
  ...
  wNAF(e, n2, r2) {
    ...
    for (let c = 0; c < i2.windows; c++) {
      const { nextN: f4, offset: u, isZero: a, isNeg: l2, isNegF: d3, offsetF: h3 } = Ko(r2, c, i2);
...
function Mf(t) {
  ...
  const f4 = i2 || Mt, u = c ? 255 : 448, a = c ? 32 : 56, l2 = BigInt(c ? 9 : 5), d3 = BigInt(c ? 121665 : 39081), h3 = c ? Fe ** BigInt(254) : Fe ** BigInt(447), y2 = c ? BigInt(8) * Fe ** BigInt(251) - ee : BigInt(4) * Fe ** BigInt(445) - ee, m2 = h3 + y2 + ee, w = (p) => ct(p, n2), U = F(l2);
  function F(p) {
    return Un(w(p), a);
  }
  function R2(p) {
  ...
  function k(p, b) {
    ...
    for (let D = BigInt(u - 1); D >= we; D--) {
      ...
      v = w(Qn * Qn), B = w(x2 * w(tr * tr)), E = w(V2 * G), I2 = w(M2 * (V2 + w(d3 * M2)));
    }
...
function zf(t) {
  const e = BigInt(10), n2 = BigInt(20), r2 = BigInt(40), o2 = BigInt(80), s = zo, c = t * t % s * t % s, f4 = gt(c, Go, s) * c % s, u = gt(f4, Kf, s) * t % s, a = gt(u, Ff, s) * u % s, l2 = gt(a, e, s) * a % s, d3 = gt(l2, n2, s) * l2 % s, h3 = gt(d3, r2, s) * d3 % s, y2 = gt(h3, o2, s) * h3 % s, m2 = gt(y2, o2, s) * h3 % s, w = gt(m2, e, s) * a % s;
...
function na(t, e, n2 = {}) {
  ...
  const r2 = n2.randomBytes || Mt, o2 = n2.hmac || ((b, ...g) => ke(e, b, _t(...g))), { Fp: s, Fn: i2 } = t, { ORDER: c, BITS: f4 } = i2, { keygen: u, getPublicKey: a, getSharedSecret: l2, utils: d3, lengths: h3 } = ea(t, n2), y2 = { prehash: false, lowS: typeof n2.lowS == "boolean" ? n2.lowS : false, format: void 0, extraEntropy: false }, m2 = "compact";
  function w(b) {
    const g = c >> ne;
    return b > g;
  }
...
// node_modules/@reown/appkit-controllers/dist/esm/src/utils/UrlUtils.js
...
var ChildPart = class _ChildPart {
   ...
   * @internal
   */
  _$clear(start = wrap(this._$startNode).nextSibling, from9) {
    this._$notifyConnectionChanged?.(false, true, from9);
...
lit-html/development/is-server.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-UOV77PEK.js.map
