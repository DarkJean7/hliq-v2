...
} from "./chunk-SFMSPQ4V.js";
import "./chunk-XGT6S6UM.js";
import "./chunk-B75YOQ2X.js";
import {
  toHex
} from "./chunk-N5BTVYBI.js";
import "./chunk-AIT75WRE.js";
import {
  C,
  IEvents,
  Po,
...
var SHA1 = class extends HashMD {
  ...
  get() {
    const { A: A3, B: B2, C: C4, D, E: E3 } = this;
    return [A3, B2, C4, D, E3];
  }
  set(A3, B2, C4, D, E3) {
    this.A = A3 | 0;
    this.B = B2 | 0;
  ...
  process(view, offset) {
    ...
    let { A: A3, B: B2, C: C4, D, E: E3 } = this;
    for (let i3 = 0; i3 < 80; i3++) {
      ...
      const T3 = rotl(A3, 5) + F2 + E3 + K6 + SHA1_W[i3] | 0;
      E3 = D;
      D = C4;
      C4 = rotl(B2, 30);
      B2 = A3;
...
var MD5 = class extends HashMD {
  ...
  process(view, offset) {
    ...
    for (let i3 = 0; i3 < 64; i3++) {
      ...
      F2 = F2 + A3 + K[i3] + MD5_W[g2];
      A3 = D;
      D = C4;
      C4 = B2;
      B2 = B2 + rotl(F2, s[i3 % 4]);
    }
    A3 = A3 + this.A | 0;
    B2 = B2 + this.B | 0;
    C4 = C4 + this.C | 0;
...
var SHA3_ROTL = [];
var _SHA3_IOTA = [];
for (let round = 0, R3 = _1n, x3 = 1, y3 = 0; round < 24; round++) {
...
function keccakP(s, rounds = 24) {
  ...
  for (let round = 24 - rounds; round < 24; round++) {
    for (let x3 = 0; x3 < 10; x3++)
      B2[x3] = s[x3] ^ s[x3 + 10] ^ s[x3 + 20] ^ s[x3 + 30] ^ s[x3 + 40];
...
var SHA256 = class extends HashMD {
  ...
  get() {
    const { A: A3, B: B2, C: C4, D, E: E3, F: F2, G: G3, H: H2 } = this;
    return [A3, B2, C4, D, E3, F2, G3, H2];
  }
  // prettier-ignore
  set(A3, B2, C4, D, E3, F2, G3, H2) {
    this.A = A3 | 0;
    this.B = B2 | 0;
    this.C = C4 | 0;
    this.D = D | 0;
  ...
  process(view, offset) {
    ...
    let { A: A3, B: B2, C: C4, D, E: E3, F: F2, G: G3, H: H2 } = this;
    for (let i3 = 0; i3 < 64; i3++) {
      const sigma1 = rotr(E3, 6) ^ rotr(E3, 11) ^ rotr(E3, 25);
      const T12 = H2 + sigma1 + Chi(E3, F2, G3) + SHA256_K[i3] + SHA256_W[i3] | 0;
    ...
    G3 = G3 + this.G | 0;
    H2 = H2 + this.H | 0;
    this.set(A3, B2, C4, D, E3, F2, G3, H2);
  }
  roundClean() {
    clean(SHA256_W);
  }
...
// node_modules/@reown/appkit/node_modules/ox/node_modules/@noble/curves/esm/abstract/utils.js
var _0n2 = BigInt(0);
var _1n2 = BigInt(1);
...
// node_modules/@reown/appkit/node_modules/ox/_esm/core/AbiError.js
...
// node_modules/@reown/appkit/node_modules/ox/_esm/core/Signature.js
...
// node_modules/@reown/appkit/node_modules/ox/node_modules/@noble/curves/esm/abstract/modular.js
var _0n3 = BigInt(0);
var _1n3 = BigInt(1);
var _2n2 = BigInt(2);
var _3n = BigInt(3);
...
function invert(number, modulo) {
  ...
  while (a2 !== _0n3) {
    ...
    const m3 = x3 - u2 * q2;
    const n2 = y3 - v4 * q2;
    b4 = a2, a2 = r2, x3 = u2, y3 = v4, u2 = m3, v4 = n2;
  }
  const gcd = b4;
  if (gcd !== _1n3)
...
function Field(ORDER, bitLen2, isLE2 = false, redef = {}) {
  ...
  const f5 = Object.freeze({
    ...
    pow: (num2, power) => FpPow(f5, num2, power),
...
// node_modules/@reown/appkit/node_modules/ox/node_modules/@noble/curves/esm/abstract/curve.js
var _0n4 = BigInt(0);
var _1n4 = BigInt(1);
...
function wNAF(c3, bits) {
  return {
    ...
    getPrecomputes(W4, P3, transform) {
    ...
    wNAFCached(P3, n2, transform) {
      const W4 = getW(P3);
      return this.wNAF(W4, this.getPrecomputes(W4, P3, transform), n2);
    },
    wNAFCachedUnsafe(P3, n2, transform, prev) {
      const W4 = getW(P3);
      if (W4 === 1)
        return this.unsafeLadder(P3, n2, prev);
      return this.wNAFUnsafe(W4, this.getPrecomputes(W4, P3, transform), n2, prev);
    },
...
// node_modules/@reown/appkit/node_modules/ox/node_modules/@noble/curves/esm/abstract/weierstrass.js
...
function weierstrassPoints(opts) {
  ...
  const toBytes6 = CURVE.toBytes || ((_c2, point, _isCompressed) => {
  ...
  function weierstrassEquation(x3) {
    ...
    return Fp4.add(Fp4.add(x32, Fp4.mul(x3, a2)), b4);
  }
  ...
  class Point2 {
    ...
    multiply(scalar) {
      ...
      if (endo2) {
        ...
        const { p: p3, f: f5 } = this.wNAF(scalar);
        point = p3;
        fake = f5;
      }
...
function weierstrass(curveDef) {
  ...
  const slcNum = (b4, from9, to3) => bytesToNumberBE(b4.slice(from9, to3));
  class Signature {
    ...
    recoverPublicKey(msgHash) {
      ...
      const R3 = Point2.fromHex(prefix + numToSizedHex(radj, Fp4.BYTES));
      const ir2 = invN(radj);
      const u1 = modN2(-h3 * ir2);
      const u2 = modN2(s * ir2);
      const Q3 = Point2.BASE.multiplyAndAddUnsafe(R3, u1, u2);
      if (!Q3)
  ...
  function verify3(signature, msgHash, publicKey, opts = defaultVerOpts) {
    ...
    const R3 = Point2.BASE.multiplyAndAddUnsafe(P3, u1, u2)?.toAffine();
    if (!R3)
      return false;
    const v4 = modN2(R3.x);
    return v4 === r2;
...
// node_modules/@reown/appkit/node_modules/ox/node_modules/@noble/curves/esm/_shortw_utils.js
...
// node_modules/@reown/appkit/node_modules/ox/node_modules/@noble/curves/esm/abstract/hash-to-curve.js
...
// node_modules/@reown/appkit/node_modules/ox/node_modules/@noble/curves/esm/secp256k1.js
...
function sqrtMod(y3) {
  ...
  const b22 = y3 * y3 * y3 % P3;
  const b32 = b22 * b22 * y3 % P3;
  const b6 = pow2(b32, _3n7, P3) * b32 % P3;
  const b9 = pow2(b6, _3n7, P3) * b32 % P3;
  ...
  const b223 = pow2(b220, _3n7, P3) * b32 % P3;
...
var GmulAdd = (Q3, a2, b4) => Point.BASE.multiplyAndAddUnsafe(Q3, a2, b4);
...
function schnorrVerify(signature, message, publicKey) {
  ...
  try {
    ...
    if (!inRange(s, _1n6, secp256k1N))
      return false;
    const e = challenge(numTo32b(r2), pointToBytes(P3), m3);
    const R3 = GmulAdd(P3, s, modN(-e));
...
// node_modules/@reown/appkit/node_modules/ox/_esm/core/internal/base58.js
...
// node_modules/@reown/appkit/node_modules/ox/_esm/core/Base64.js
...
// node_modules/@reown/appkit/node_modules/@noble/hashes/esm/_blake.js
...
function G1s(a2, b4, c3, d4, x3) {
  a2 = a2 + b4 + x3 | 0;
  d4 = rotr(d4 ^ a2, 16);
  c3 = c3 + d4 | 0;
  b4 = rotr(b4 ^ c3, 12);
  return { a: a2, b: b4, c: c3, d: d4 };
}
function G2s(a2, b4, c3, d4, x3) {
  a2 = a2 + b4 + x3 | 0;
  d4 = rotr(d4 ^ a2, 8);
  c3 = c3 + d4 | 0;
  b4 = rotr(b4 ^ c3, 7);
...
// node_modules/@reown/appkit/node_modules/@noble/hashes/esm/blake2.js
...
function G1b(a2, b4, c3, d4, msg, x3) {
...
function G2b(a2, b4, c3, d4, msg, x3) {
  const Xl = msg[x3], Xh = msg[x3 + 1];
  let Al = BBUF[2 * a2], Ah = BBUF[2 * a2 + 1];
  let Bl = BBUF[2 * b4], Bh = BBUF[2 * b4 + 1];
  let Cl = BBUF[2 * c3], Ch = BBUF[2 * c3 + 1];
...
// node_modules/@reown/appkit/node_modules/@noble/hashes/esm/blake3.js
var B3_Flags = {
  CHUNK_START: 1,
  CHUNK_END: 2,
  PARENT: 4,
...
// node_modules/@reown/appkit/node_modules/ox/_esm/core/Blobs.js
...
// node_modules/@reown/appkit/node_modules/ox/node_modules/@noble/curves/esm/abstract/bls.js
var _0n7 = BigInt(0);
var _1n7 = BigInt(1);
var _2n5 = BigInt(2);
var _3n3 = BigInt(3);
...
function bls(CURVE) {
  ...
  if (TWIST === "multiplicative") {
    lineFunction = (c0, c1, c22, f5, Px, Py) => Fp122.mul014(f5, c0, Fp22.mul(c1, Px), Fp22.mul(c22, Py));
  } else if (TWIST === "divisive") {
    lineFunction = (c0, c1, c22, f5, Px, Py) => Fp122.mul034(f5, Fp22.mul(c22, Py), Fp22.mul(c1, Px), c0);
  } else
...
// node_modules/@reown/appkit/node_modules/ox/node_modules/@noble/curves/esm/abstract/tower.js
var _0n8 = BigInt(0);
var _1n8 = BigInt(1);
var _2n6 = BigInt(2);
var _3n4 = BigInt(3);
...
function tower12(opts) {
  ...
  const Fp2Square = ({ c0, c1 }) => {
    ...
    return { c0: Fp4.mul(a2, b4), c1: Fp4.mul(c3, c1) };
  };
  ...
  const Fp22 = {
    ...
    inv: ({ c0: a2, c1: b4 }) => {
      const factor = Fp4.inv(Fp4.create(a2 * a2 + b4 * b4));
      return { c0: Fp4.mul(factor, Fp4.create(a2)), c1: Fp4.mul(factor, Fp4.create(-b4)) };
    },
    sqrt: (num2) => {
      if (opts.Fp2sqrt)
...
// node_modules/@reown/appkit/node_modules/ox/node_modules/@noble/curves/esm/bls12-381.js
var _0n9 = BigInt(0);
var _1n9 = BigInt(1);
var _2n7 = BigInt(2);
var _3n5 = BigInt(3);
...
var bls12_381 = bls({
  ...
  G2: {
    ...
    isTorsionFree: (c3, P3) => {
      return P3.multiplyUnsafe(BLS_X).negate().equals(G2psi(c3, P3));
    },
    ...
    clearCofactor: (c3, P3) => {
      const x3 = BLS_X;
      let t1 = P3.multiplyUnsafe(x3).negate();
      let t2 = G2psi(c3, P3);
      let t3 = P3.double();
      t3 = G2psi2(c3, t3);
      t3 = t3.subtract(t2);
    ...
    fromBytes: (bytes) => {
      ...
      const L2 = Fp.BYTES;
      const slc = (b4, from9, to3) => bytesToNumberBE(b4.slice(from9, to3));
      if (value.length === 96 && compressed) {
        ...
        const right = Fp2.add(Fp2.pow(x3, _3n5), b4);
        let y3 = Fp2.sqrt(right);
        const Y_bit = y3.c1 === _0n9 ? y3.c0 * _2n7 / P3 : y3.c1 * _2n7 / P3 ? _1n9 : _0n9;
    ...
    toBytes: (c3, point, isCompressed) => {
      ...
      if (isCompressed) {
        if (isZero)
          return concatBytes2(COMPRESSED_ZERO, numberToBytesBE(_0n9, len));
        const flag = Boolean(y3.c1 === _0n9 ? y3.c0 * _2n7 / P3 : y3.c1 * _2n7 / P3);
...
// node_modules/@reown/appkit/node_modules/ox/node_modules/@noble/curves/esm/abstract/edwards.js
var _0n10 = BigInt(0);
var _1n10 = BigInt(1);
var _2n8 = BigInt(2);
var _8n2 = BigInt(8);
...
function twistedEdwards(curveDef) {
  ...
  const assertValidMemo = memoized((p3) => {
    ...
    if (p3.is0())
      throw new Error("bad point: ZERO");
    const { ex: X3, ey: Y2, ez: Z, et: T3 } = p3;
  ...
  class Point2 {
    ...
    double() {
      ...
      const D = modP2(a2 * A3);
      const x1y1 = X1 + Y1;
      const E3 = modP2(modP2(x1y1 * x1y1) - A3 - B2);
      const G4 = D + B2;
      const F2 = G4 - C4;
      const H2 = D - B2;
      const X3 = modP2(E3 * F2);
    ...
    add(other) {
      ...
      const { ex: X22, ey: Y2, ez: Z2, et: T22 } = other;
      const A3 = modP2(X1 * X22);
      const B2 = modP2(Y1 * Y2);
      const C4 = modP2(T12 * d4 * T22);
      const D = modP2(Z1 * Z2);
      const E3 = modP2((X1 + Y1) * (X22 + Y2) - A3 - B2);
      const F2 = D - C4;
      const G4 = D + C4;
    ...
    multiply(scalar) {
      ...
      const { p: p3, f: f5 } = this.wNAF(n2);
      return Point2.normalizeZ([p3, f5])[0];
    }
    // Non-constant-time multiplication. Uses double-and-add algorithm.
    // It's faster, but should only be used when you don't care about
  ...
  function sign2(msg, privKey, options = {}) {
    ...
    const k2 = hashDomainToScalar(options.context, R3, pointBytes, msg);
    const s = modN2(r2 + k2 * scalar);
    aInRange("signature.s", s, _0n10, CURVE_ORDER);
    const res = concatBytes2(R3, numberToBytesLE(s, Fp4.BYTES));
  ...
  function verify3(sig, msg, publicKey, options = verifyOpts) {
    ...
    try {
      ...
      R3 = Point2.fromHex(sig.slice(0, len), zip215);
    ...
    if (!zip215 && A3.isSmallOrder())
      return false;
    const k2 = hashDomainToScalar(context, R3.toRawBytes(), A3.toRawBytes(), msg);
    const RkA = R3.add(A3.multiplyUnsafe(k2));
...
// node_modules/@reown/appkit/node_modules/ox/node_modules/@noble/curves/esm/abstract/montgomery.js
var _0n11 = BigInt(0);
var _1n11 = BigInt(1);
var _2n9 = BigInt(2);
...
function montgomery(curveDef) {
  ...
  const { P: P3, type, adjustScalarBytes: adjustScalarBytes2, powPminus2 } = CURVE;
...
// node_modules/@reown/appkit/node_modules/ox/node_modules/@noble/curves/esm/ed25519.js
...
function ed25519_pow_2_252_3(x3) {
  ...
  const b5 = pow2(b4, _1n12, P3) * x3 % P3;
  ...
  const pow_p_5_8 = pow2(b250, _2n10, P3) * x3 % P3;
...
function uvRatio(u2, v4) {
  const P3 = ED25519_P;
  const v32 = mod(v4 * v4 * v4, P3);
  const v7 = mod(v32 * v32 * v4, P3);
  const pow = ed25519_pow_2_252_3(u2 * v7).pow_p_5_8;
  let x3 = mod(u2 * v32 * pow, P3);
  const vx2 = mod(v4 * x3 * x3, P3);
  const root1 = x3;
  const root2 = mod(x3 * ED25519_SQRT_M1, P3);
...
var RistPoint = class _RistPoint {
  ...
  static fromHex(hex) {
    ...
    const y3 = mod2(u1 * Dy);
    const t = mod2(x3 * y3);
    if (!isValid || isNegativeLE(t, P3) || y3 === _0n12)
      throw new Error(emsg);
...
// node_modules/@reown/appkit/node_modules/@adraffy/ens-normalize/dist/index.mjs
var S0 = 44032;
var L0 = 4352;
var V0 = 4449;
var T0 = 4519;
...
// node_modules/@reown/appkit/node_modules/ox/_esm/core/Secp256k1.js
...
// node_modules/@reown/appkit/node_modules/ox/_esm/core/internal/entropy.js
...
// node_modules/@reown/appkit/node_modules/ox/node_modules/@noble/curves/esm/nist.js
...
// node_modules/@reown/appkit/node_modules/ox/node_modules/@noble/curves/esm/p256.js
var hashToCurve3 = (() => p256_hasher.hashToCurve)();
var encodeToCurve3 = (() => p256_hasher.encodeToCurve)();

// node_modules/@reown/appkit/node_modules/ox/_esm/core/RpcResponse.js
...
// node_modules/@reown/appkit/node_modules/ox/_esm/core/Provider.js
...
// node_modules/@reown/appkit/node_modules/ox/_esm/core/WebAuthnP256.js
...
// node_modules/@reown/appkit/node_modules/@msgpack/msgpack/dist.esm/utils/utf8.mjs
...
// node_modules/@reown/appkit/node_modules/@msgpack/msgpack/dist.esm/ExtData.mjs
var ExtData = class {
...
// node_modules/@reown/appkit/node_modules/@msgpack/msgpack/dist.esm/DecodeError.mjs
...
// node_modules/@reown/appkit/node_modules/@msgpack/msgpack/dist.esm/utils/int.mjs
...
// node_modules/@reown/appkit/node_modules/@msgpack/msgpack/dist.esm/timestamp.mjs
var EXT_TIMESTAMP = -1;
...
// node_modules/@reown/appkit/node_modules/@msgpack/msgpack/dist.esm/ExtensionCodec.mjs
...
// node_modules/@reown/appkit/node_modules/@msgpack/msgpack/dist.esm/utils/typedArrays.mjs
...
// node_modules/@reown/appkit/node_modules/@msgpack/msgpack/dist.esm/Encoder.mjs
...
// node_modules/@reown/appkit/node_modules/@msgpack/msgpack/dist.esm/encode.mjs
function encode3(value, options) {
  const encoder4 = new Encoder(options);
  return encoder4.encodeSharedRef(value);
}

// node_modules/@reown/appkit/node_modules/@msgpack/msgpack/dist.esm/utils/prettyByte.mjs
function prettyByte(byte) {
  return `${byte < 0 ? "-" : ""}0x${Math.abs(byte).toString(16).padStart(2, "0")}`;
}

// node_modules/@reown/appkit/node_modules/@msgpack/msgpack/dist.esm/CachedKeyDecoder.mjs
...
// node_modules/@reown/appkit/node_modules/@msgpack/msgpack/dist.esm/Decoder.mjs
...
// node_modules/@reown/appkit/node_modules/@msgpack/msgpack/dist.esm/decode.mjs
...
function Rc(t) {
  ...
  const r2 = encode3(n2), o2 = Buffer.from("TX"), s = Buffer.concat([o2, Buffer.from(r2)]), i3 = vc(s);
...
var ro = (t, e) => {
  ...
  const i3 = `URI: ${t.aud || t.uri}`, c3 = `Version: ${t.version}`, f5 = `Chain ID: ${to(e)}`, u2 = `Nonce: ${t.nonce}`, a2 = `Issued At: ${t.iat}`, l2 = t.exp ? `Expiration Time: ${t.exp}` : void 0, d4 = t.nbf ? `Not Before: ${t.nbf}` : void 0, h3 = t.requestId ? `Request ID: ${t.requestId}` : void 0, y3 = t.resources ? `Resources:${t.resources.map((w2) => `
...
function bf(t, e, n2, r2, o2, s = 20) {
  ...
  for (let D = 0; D < s; D += 2) j4 = j4 + T3 | 0, I2 = K2(I2 ^ j4, 16), b4 = b4 + I2 | 0, T3 = K2(T3 ^ b4, 12), j4 = j4 + T3 | 0, I2 = K2(I2 ^ j4, 8), b4 = b4 + I2 | 0, T3 = K2(T3 ^ b4, 7), L2 = L2 + C4 | 0, v4 = K2(v4 ^ L2, 16), g2 = g2 + v4 | 0, C4 = K2(C4 ^ g2, 12), L2 = L2 + C4 | 0, v4 = K2(v4 ^ L2, 8), g2 = g2 + v4 | 0, C4 = K2(C4 ^ g2, 7), k2 = k2 + _2 | 0, B2 = K2(B2 ^ k2, 16), x3 = x3 + B2 | 0, _2 = K2(_2 ^ x3, 12), k2 = k2 + _2 | 0, B2 = K2(B2 ^ k2, 8), x3 = x3 + B2 | 0, _2 = K2(_2 ^ x3, 7), O3 = O3 + p3 | 0, A3 = K2(A3 ^ O3, 16), E3 = E3 + A3 | 0, p3 = K2(p3 ^ E3, 12), O3 = O3 + p3 | 0, A3 = K2(A3 ^ O3, 8), E3 = E3 + A3 | 0, p3 = K2(p3 ^ E3, 7), j4 = j4 + C4 | 0, A3 = K2(A3 ^ j4, 16), x3 = x3 + A3 | 0, C4 = K2(C4 ^ x3, 12), j4 = j4 + C4 | 0, A3 = K2(A3 ^ j4, 8), x3 = x3 + A3 | 0, C4 = K2(C4 ^ x3, 7), L2 = L2 + _2 | 0, I2 = K2(I2 ^ L2, 16), E3 = E3 + I2 | 0, _2 = K2(_2 ^ E3, 12), L2 = L2 + _2 | 0, I2 = K2(I2 ^ L2, 8), E3 = E3 + I2 | 0, _2 = K2(_2 ^ E3, 7), k2 = k2 + p3 | 0, v4 = K2(v4 ^ k2, 16), b4 = b4 + v4 | 0, p3 = K2(p3 ^ b4, 12), k2 = k2 + p3 | 0, v4 = K2(v4 ^ k2, 8), b4 = b4 + v4 | 0, p3 = K2(p3 ^ b4, 7), O3 = O3 + T3 | 0, B2 = K2(B2 ^ O3, 16), g2 = g2 + B2 | 0, T3 = K2(T3 ^ g2, 12), O3 = O3 + T3 | 0, B2 = K2(B2 ^ O3, 8), g2 = g2 + B2 | 0, T3 = K2(T3 ^ g2, 7);
  let N4 = 0;
...
function Kt(t, e, n2 = "") {
  const r2 = Ue2(t), o2 = t?.length, s = e !== void 0;
  if (!r2 || s && o2 !== e) {
...
function ze(t) {
  const e = (t.encoding || oe) === Ge2 ? os(t.encoded) : t.encoded, n2 = fromString(e, oe), r2 = n2.slice(da, ns), o2 = ns;
  if (Zt(r2) === ie) {
...
var Yn2 = class extends m {
  constructor(e, t) {
    super(e, t), this.relayer = e, this.logger = t, G(this, "events", new import_events3.EventEmitter()), G(this, "name", xt2), G(this, "queue", /* @__PURE__ */ new Map()), G(this, "publishTimeout", (0, import_time2.toMiliseconds)(import_time2.ONE_MINUTE)), G(this, "initialPublishTimeout", (0, import_time2.toMiliseconds)(import_time2.ONE_SECOND * 15)), G(this, "needsTransportRestart", false), G(this, "publish", async (i3, s, n2) => {
      ...
      const g2 = n2?.ttl || At2, y3 = n2?.prompt || false, _2 = n2?.tag || 0, u2 = n2?.id || getBigIntRpcId().toString(), m3 = Oa(Sa().protocol), D = { id: u2, method: n2?.publishMethod || m3.publish, params: ce({ topic: i3, message: s, ttl: g2, prompt: y3, tag: _2, attestation: n2?.attestation }, n2?.tvf) }, w2 = `Failed to publish payload, please try again. id:${u2} tag:${_2}`;
      try {
        ...
        const E3 = new Promise(async (L2) => {
          ...
          try {
            ...
            this.queue.set(u2, { request: D, opts: n2, attempt: 1 }), this.logger.warn(T3, T3?.message);
          }
        });
        this.logger.trace({ type: "method", method: "publish", params: { id: u2, topic: i3, message: s, opts: n2 } }), await Si(E3, this.publishTimeout, w2);
      } catch (E3) {
        if (this.logger.debug("Failed to Publish Payload"), this.logger.error(E3), (l2 = n2?.internal) != null && l2.throwOnFailedPublish) throw E3;
      } finally {
      ...
      try {
        ...
        const T3 = new Promise(async (S4) => {
          ...
          try {
            ...
            this.queue.set(w2, { request: I2, opts: l2, attempt: 1 }), this.logger.warn(Z, Z?.message);
          }
        });
...
var Si2 = class extends P {
  ...
  async rpcSubscribe(e, t, i3) {
    ...
    (!i3 || i3?.transportType === ee3.relay) && await this.restartToComplete({ topic: e, id: e, relay: t });
    ...
    try {
      if (i3?.transportType === ee3.link_mode) return setTimeout(() => {
        ...
        try {
          const _2 = await Si(new Promise((u2, m3) => {
            this.relayer.request(a2).catch((D) => {
              this.logger.warn(D, D?.message), m3(D);
            }).then(u2);
...
var Ui2 = class {
  constructor(e, t) {
    this.core = e, this.logger = t, d2(this, "name", Kt2), d2(this, "version", Bt2), d2(this, "events", new import_events3.default()), d2(this, "pairings"), d2(this, "initialized", false), d2(this, "storagePrefix", W2), d2(this, "ignoredPayloadTypes", [ie]), d2(this, "registeredMethods", []), d2(this, "init", async () => {
      ...
      this.isInitialized();
      const s = this.core.eventClient.createEvent({ properties: { topic: i3?.uri, trace: [Y.pairing_started] } });
...
var Oe = class _Oe extends h2 {
  constructor(e) {
    ...
    const s = Ge({ level: typeof e?.logger == "string" && e.logger ? e.logger : Et2.logger, name: ge2 }), { logger: n2, chunkLoggerController: o2 } = Ue({ opts: s, maxSizeInBytes: e?.maxLogBlobSizeInBytes, loggerOverride: e?.logger });
...
var K4 = { idle: "IDLE", active: "ACTIVE" };
...
var Ds = class extends V {
  constructor(o2) {
    super(o2), c2(this, "name", gt2), c2(this, "events", new import_events4.default()), c2(this, "initialized", false), c2(this, "requestQueue", { state: K4.idle, queue: [] }), c2(this, "sessionRequestQueue", { state: K4.idle, queue: [] }), c2(this, "emittedSessionRequests", new Hi({ limit: 500 })), c2(this, "requestQueueDelay", import_time3.ONE_SECOND), c2(this, "expectedPairingMethodMap", /* @__PURE__ */ new Map()), c2(this, "recentlyDeletedMap", /* @__PURE__ */ new Map()), c2(this, "recentlyDeletedLimit", 200), c2(this, "relayMessageCache", []), c2(this, "pendingSessions", /* @__PURE__ */ new Map()), c2(this, "init", async () => {
      ...
      const { pairingTopic: i3, requiredNamespaces: r2, optionalNamespaces: n2, sessionProperties: a2, scopedProperties: l2, relays: h3, authentication: p3, walletPay: y3 } = s, d4 = ((t = p3?.[0]) == null ? void 0 : t.ttl) || N2.wc_sessionPropose.req.ttl || import_time3.FIVE_MINUTES;
      ...
      try {
        ...
        throw this.client.logger.error(`approve() -> proposal.get(${e?.id}) failed`), r2.setError(nr2.proposal_not_found), q2;
      }
      try {
      ...
      const R3 = b2(E({}, U3), { topic: x3, requiredNamespaces: f5, optionalNamespaces: v4, pairingTopic: w2, acknowledged: false, self: U3.controller, peer: { publicKey: g2.publicKey, metadata: g2.metadata }, controller: A3, transportType: ee3.relay, authentication: d4?.authentication, walletPayResult: d4?.walletPay });
      ...
      n2?.transportType === ee3.relay && await this.confirmOnlineStateOrThrow();
      ...
      try {
        ...
        throw i3.addTrace(p3?.message), i3.setError(nr2.session_request_response_validation_failure), p3;
      }
      ...
      try {
        ...
        throw i3.addTrace(p3?.message), i3.setError(nr2.session_request_response_publish_failure), p3;
      }
      ...
      await this.client.core.relayer.unsubscribe(s), await this.client.session.delete(s, zt("USER_DISCONNECTED")), this.addToRecentlyDeleted(s, "session"), this.client.core.crypto.keychain.has(a2.publicKey) && await this.client.core.crypto.deleteKeyPair(a2.publicKey), this.client.core.crypto.keychain.has(s) && await this.client.core.crypto.deleteSymKey(s), i3 || this.client.core.expirer.del(s), this.client.core.storage.removeItem($e2).catch((l2) => this.client.logger.warn(l2)), s === ((t = this.sessionRequestQueue.queue[0]) == null ? void 0 : t.topic) && (this.sessionRequestQueue.state = K4.idle), await Promise.all(this.getPendingSessionRequests().filter((l2) => l2.topic === s).map((l2) => this.deletePendingSessionRequest(l2.id, zt("USER_DISCONNECTED")))), r2 && this.client.events.emit("session_delete", { id: n2, topic: s });
      ...
      await Promise.all([this.client.pendingRequest.delete(e, t), s ? Promise.resolve() : this.client.core.expirer.del(e)]), this.addToRecentlyDeleted(e, "request"), this.sessionRequestQueue.queue = this.sessionRequestQueue.queue.filter((i3) => i3.id !== e), s && (this.sessionRequestQueue.state = K4.idle, this.client.events.emit("session_request_expire", { id: e }));
      ...
      try {
        ...
        try {
          ...
          this.client.logger.warn(`sendResult() -> getTVFParams() failed: ${w2?.message}`);
        }
      } catch (u2) {
      ...
      if (this.requestQueue.state === K4.active) {
        this.client.logger.info("Request queue already active, skipping...");
        return;
      }
      for (this.client.logger.info(`Request queue starting with ${this.requestQueue.queue.length} requests`); this.requestQueue.queue.length > 0; ) {
        this.requestQueue.state = K4.active;
      ...
      this.requestQueue.state = K4.idle;
      ...
      try {
        ...
        this.client.events.listenerCount("session_proposal") === 0 && (console.warn("No listener for session_proposal event"), l2?.setError(X2.proposal_listener_not_found)), this.isValidConnect(E({}, s.params));
        ...
        l2?.addTrace(Y.emit_session_proposal), this.client.events.emit("session_proposal", { id: a2, params: p3, verifyContext: y3 });
      } catch (l2) {
      ...
      this.deletePendingSessionRequest(e.response.id, { message: "fulfilled", code: 0 }), setTimeout(() => {
        this.sessionRequestQueue.state = K4.idle, this.processSessionRequestQueue();
      }, (0, import_time3.toMiliseconds)(this.requestQueueDelay));
      ...
      if (this.sessionRequestQueue.state === K4.active) {
      ...
      this.sessionRequestQueue.state = K4.active, this.emittedSessionRequests.add(e.id), this.client.events.emit("session_request", e);
      ...
      return !e || t !== ee3.link_mode ? false : ((i3 = (s = this.client.metadata) == null ? void 0 : s.redirect) == null ? void 0 : i3.linkMode) === true && ((n2 = (r2 = this.client.metadata) == null ? void 0 : r2.redirect) == null ? void 0 : n2.universal) !== void 0 && ((l2 = (a2 = this.client.metadata) == null ? void 0 : a2.redirect) == null ? void 0 : l2.universal) !== "" && ((h3 = e?.redirect) == null ? void 0 : h3.universal) !== void 0 && ((p3 = e?.redirect) == null ? void 0 : p3.universal) !== "" && ((y3 = e?.redirect) == null ? void 0 : y3.linkMode) === true && this.client.core.linkModeSupportedApps.includes(e.redirect.universal) && typeof (global == null ? void 0 : global.Linking) < "u";
...
async function Lt3(t, e) {
  ...
  const n2 = !a2.length || a2.some((h3) => !h3), c3 = a2.every((h3) => h3?.status === "0x1"), o2 = a2.every((h3) => h3?.status === "0x0"), p3 = a2.some((h3) => h3?.status === "0x0");
  let l2;
...
var kt3 = class {
  constructor(e) {
    g(this, "name", "eip155"), g(this, "client"), g(this, "chainId"), g(this, "namespace"), g(this, "httpProviders"), g(this, "events"), g(this, "storage"), this.namespace = e.namespace, this.events = w("events"), this.client = w("client"), this.httpProviders = this.createHttpProviders(), this.chainId = parseInt(this.getDefaultChain()), this.storage = K5.getStorage(this.client.core.storage);
  }
  async request(e) {
  ...
  async getCapabilities(e) {
    ...
    const p3 = this.client.session.get(e.topic), l2 = ((n2 = p3?.sessionProperties) == null ? void 0 : n2.capabilities) || {}, h3 = o2.length > 0 ? o2.join(",") : `0x${this.chainId.toString(16)}`, f5 = `${c3}${h3}`, u2 = l2?.[f5];
    if (u2) return u2;
    let q2;
    try {
      q2 = jt3(p3, c3, o2);
  ...
  async sendCalls(e) {
    var s, i3, r2;
    const a2 = await this.client.request(e), n2 = (s = e.request.params) == null ? void 0 : s[0], c3 = a2?.id, o2 = a2?.capabilities || {}, p3 = (i3 = o2?.caip345) == null ? void 0 : i3.caip2, l2 = (r2 = o2?.caip345) == null ? void 0 : r2.transactionHashes;
...
var N3 = class _N {
  constructor(e) {
    ...
    var s, i3;
    this.providerOpts = e, this.logger = Iu({ logger: (s = e.logger) != null ? s : oe3, name: (i3 = this.providerOpts.name) != null ? i3 : he3 }), this.disableProviderPing = e?.disableProviderPing || false;
  }
  static async init(e) {
    const s = new _N(e);
...
var AppKitBaseClient = class {
  ...
  async initialize(options) {
    ...
    if (OptionsController.state.features?.reownAuthentication || OptionsController.state.remoteFeatures?.reownAuthentication) {
      const { ReownAuthentication } = await import("./features-DZ7IVBYK.js");
...
var AppKit = class extends AppKitBaseClient {
  ...
  async injectModalUi() {
    if (!isInitialized && CoreHelperUtil.isClient()) {
      await import("./basic-U5Z4S5IR.js");
      await import("./w3m-modal-3HS3UFS3.js");
...
var PACKAGE_VERSION = "1.8.17-wc-circular-dependencies-fix.0";
...
*/
//# sourceMappingURL=core-N4IYU7ER.js.map
