import {
  ...
  u64Lengths,
  wrapCipher
} from "./chunk-4HMFG2XO.js";
import {
  Ge,
  Re,
  Ue,
  ee
} from "./chunk-C622376M.js";
import {
  __export,
  __toESM
...
var RIPEMD160 = class extends HashMD {
  ...
  process(view, offset) {
    ...
    let al = this.h0 | 0, ar2 = al, bl = this.h1 | 0, br2 = bl, cl = this.h2 | 0, cr2 = cl, dl = this.h3 | 0, dr = dl, el = this.h4 | 0, er2 = el;
    for (let group = 0; group < 5; group++) {
      ...
      for (let i3 = 0; i3 < 16; i3++) {
        const tr2 = rotl(ar2 + ripemd_f(rGroup, br2, cr2, dr) + BUF_160[rr2[i3]] + hbr, sr2[i3]) + er2 | 0;
        ar2 = er2, er2 = dr, dr = rotl(cr2, 10) | 0, cr2 = br2, br2 = tr2;
      }
    }
    this.set(this.h1 + cl + dr | 0, this.h2 + dl + er2 | 0, this.h3 + el + ar2 | 0, this.h4 + al + br2 | 0, this.h0 + bl + cr2 | 0);
  }
  roundClean() {
    clean2(BUF_160);
  }
...
var SHA256 = class extends HashMD {
  ...
  get() {
    const { A: A4, B: B3, C: C4, D: D4, E: E4, F: F4, G: G3, H: H4 } = this;
    return [A4, B3, C4, D4, E4, F4, G3, H4];
  }
  // prettier-ignore
  set(A4, B3, C4, D4, E4, F4, G3, H4) {
    this.A = A4 | 0;
    this.B = B3 | 0;
    this.C = C4 | 0;
    this.D = D4 | 0;
  ...
  process(view, offset) {
    ...
    let { A: A4, B: B3, C: C4, D: D4, E: E4, F: F4, G: G3, H: H4 } = this;
    for (let i3 = 0; i3 < 64; i3++) {
      const sigma1 = rotr(E4, 6) ^ rotr(E4, 11) ^ rotr(E4, 25);
      const T12 = H4 + sigma1 + Chi(E4, F4, G3) + SHA256_K[i3] + SHA256_W[i3] | 0;
    ...
    G3 = G3 + this.G | 0;
    H4 = H4 + this.H | 0;
    this.set(A4, B3, C4, D4, E4, F4, G3, H4);
  }
  roundClean() {
    clean2(SHA256_W);
  }
...
function tonelliShanks(P3) {
  ...
  return function tonelliSlow(Fp5, n2) {
    ...
    while (!Fp5.eql(t, Fp5.ONE)) {
      ...
      const exponent = _1n3 << BigInt(M5 - i3 - 1);
...
function isogenyMap(field, map2) {
  ...
  return (x6, y5) => {
    const [xn2, xd, yn, yd] = coeff.map((val) => val.reduce((acc, i3) => field.add(field.mul(acc, x6), i3)));
...
function bls(CURVE) {
  const { Fp: Fp5, Fr: Fr3, Fp2: Fp22, Fp6: Fp62, Fp12: Fp122 } = CURVE.fields;
  const BLS_X_IS_NEGATIVE = CURVE.params.xNegative;
  const TWIST = CURVE.params.twistType;
  const G1_ = weierstrassPoints({ n: Fr3.ORDER, ...CURVE.G1 });
  const G1 = Object.assign(G1_, createHasher2(G1_.ProjectivePoint, CURVE.G1.mapToCurve, {
    ...CURVE.htfDefaults,
    ...CURVE.G1.htfDefaults
  }));
  const G2_ = weierstrassPoints({ n: Fr3.ORDER, ...CURVE.G2 });
  ...
  const utils = {
    randomPrivateKey: () => {
      ...
      return mapHashToField(CURVE.randomBytes(length), Fr3.ORDER);
    },
...
function twistedEdwards(curveDef) {
  ...
  class Point2 {
    ...
    add(other) {
      ...
      const C4 = modP2(T12 * d3 * T22);
      const D4 = modP2(Z1 * Z22);
...
function map_to_curve_elligator2_curve25519(u4) {
  ...
  return { xMn: xn2, xMd: xd, yMn: y5, yMd: _1n12 };
}
...
function map_to_curve_elligator2_edwards25519(u4) {
  ...
  return { x: Fp3.mul(xn2, xd_inv), y: Fp3.mul(yn, yd_inv) };
}
...
function calcElligatorRistrettoMap(r0) {
  ...
  const Ns = mod3((r2 + _1n12) * ONE_MINUS_D_SQ);
  let c2 = BigInt(-1);
  const D4 = mod3((c2 - d3 * r2) * mod3(r2 + d3));
  let { isValid: Ns_D_is_sq, value: s } = uvRatio(Ns, D4);
  let s_ = mod3(s * r0);
  ...
  if (!Ns_D_is_sq)
    c2 = r2;
  const Nt2 = mod3(c2 * (r2 - _1n12) * D_MINUS_ONE_SQ - D4);
  const s2 = s * s;
  const W0 = mod3((s + s) * D4);
...
// node_modules/@walletconnect/utils/node_modules/@adraffy/ens-normalize/dist/index.mjs
var S0 = 44032;
var L0 = 4352;
var V0 = 4449;
var T0 = 4519;
...
function tonelliShanks2(P3) {
  ...
  return function tonelliSlow(Fp5, n2) {
    ...
    while (!Fp5.eql(t, Fp5.ONE)) {
      ...
      const exponent = _1n14 << BigInt(M5 - i3 - 1);
      const b4 = Fp5.pow(c2, exponent);
      M5 = i3;
      c2 = Fp5.sqr(b4);
      t = Fp5.mul(t, c2);
...
var wNAF2 = class {
  ...
  wNAF(W4, precomputes, n2) {
    ...
    let p4 = this.ZERO;
    let f4 = this.BASE;
    const wo = calcWOpts2(W4, this.bits);
    for (let window2 = 0; window2 < wo.windows; window2++) {
...
function map_to_curve_elligator2_curve255192(u4) {
  ...
  let xn2 = Fp4.cmov(x2n, x1n, e3);
  let y5 = Fp4.cmov(y23, y1, e3);
  let e4 = Fp4.isOdd(y5);
  y5 = Fp4.cmov(y5, Fp4.neg(y5), e3 !== e4);
  return { xMn: xn2, xMd: xd, yMn: y5, yMd: _1n18 };
}
...
function map_to_curve_elligator2_edwards255192(u4) {
  ...
  return { x: Fp4.mul(xn2, xd_inv), y: Fp4.mul(yn, yd_inv) };
}
...
function calcElligatorRistrettoMap2(r0) {
  ...
  const Ns = mod3((r2 + _1n18) * ONE_MINUS_D_SQ2);
  let c2 = BigInt(-1);
  const D4 = mod3((c2 - d3 * r2) * mod3(r2 + d3));
  let { isValid: Ns_D_is_sq, value: s } = uvRatio2(Ns, D4);
  let s_ = mod3(s * r0);
  ...
  if (!Ns_D_is_sq)
    c2 = r2;
  const Nt2 = mod3(c2 * (r2 - _1n18) * D_MINUS_ONE_SQ2 - D4);
  const s2 = s * s;
  const W0 = mod3((s + s) * D4);
...
function $n({ protocol: e, version: t, relayUrl: n2, sdkVersion: r2, auth: o2, projectId: s, useOnCloseEvent: i3, bundleId: a2, packageName: l }) {
...
function Mn(e = import_time.FIVE_MINUTES, t) {
...
async function Jn({ id: e, topic: t, wcDeepLink: n2 }) {
  try {
    if (!n2) return;
...
var er = "https://rpc.walletconnect.org/v1";
function k(e) {
  const t = e + "=".repeat((4 - e.length % 4) % 4), n2 = atob(t), r2 = new Uint8Array(n2.length);
  for (let o2 = 0; o2 < n2.length; o2++) r2[o2] = n2.charCodeAt(o2);
  return r2;
...
function rr(e) {
  const t = k(e), n2 = new TextEncoder().encode("TransactionData::"), r2 = new Uint8Array(n2.length + t.length);
...
function sr(e) {
  const t = k(e), n2 = decode2(t).txn;
  if (!n2) throw new Error("Invalid signed transaction: missing 'txn' field");
  const r2 = encode3(n2), o2 = new TextEncoder().encode("TX"), s = concat([o2, new Uint8Array(r2)]), i3 = sha512_256(s);
...
function ir(e) {
  const t = k(e.signed.bodyBytes), n2 = k(e.signed.authInfoBytes), r2 = k(e.signature.signature), o2 = [];
...
var ut = "did:pkh:";
var ar = { eip155: "Ethereum", solana: "Solana", bip122: "Bitcoin" };
var ur = (e) => e ? ar[e] || e : "";
var K2 = (e) => e?.split(":");
var lt = (e) => {
  const t = e && K2(e);
...
async function lr(e) {
  const { cacao: t, projectId: n2 } = e, { s: r2, p: o2 } = t, s = pt(o2, o2.iss), i3 = Ee(o2.iss);
  return await st(i3, s, r2, ft(o2.iss), n2);
}
var pt = (e, t) => {
  const n2 = dt(t);
  if (!n2) throw new Error("Invalid issuer: " + t);
  const r2 = `${e.domain} wants you to sign in with your ${ur(n2)} account:`, o2 = Ee(t);
  if (!e.aud && !e.uri) throw new Error("Either `aud` or `uri` is required to construct the message");
  let s = e.statement || void 0;
  const i3 = `URI: ${e.aud || e.uri}`, a2 = `Version: ${e.version}`, l = `Chain ID: ${lt(t)}`, c2 = `Nonce: ${e.nonce}`, d3 = `Issued At: ${e.iat}`, u4 = e.exp ? `Expiration Time: ${e.exp}` : void 0, p4 = e.nbf ? `Not Before: ${e.nbf}` : void 0, b4 = e.requestId ? `Request ID: ${e.requestId}` : void 0, f4 = e.resources ? `Resources:${e.resources.map((V3) => `
- ${V3}`).join("")}` : void 0, O3 = Z(e.resources);
  if (O3) {
    const V3 = T(O3);
    s = Ne(s, V3);
  }
  return [r2, o2, "", s, "", i3, a2, l, c2, d3, u4, p4, b4, f4].filter((V3) => V3 != null).join(`
`);
};
function yt(e) {
...
function Or(e) {
  const t = sha2562(fromString(e, _));
  return toString(t, y);
}
function Ae(e) {
...
function Ar(e) {
  ...
  const n2 = typeof e.senderPublicKey < "u" ? fromString(e.senderPublicKey, y) : void 0, r2 = typeof e.iv < "u" ? fromString(e.iv, y) : randomBytes(q), o2 = fromString(e.symKey, y), s = chacha20poly1305(o2, r2).encrypt(fromString(e.message, _)), i3 = Ie({ type: t, sealed: s, iv: r2, senderPublicKey: n2 });
...
function Tr(e, t) {
  const n2 = Ae(F), r2 = randomBytes(q), o2 = fromString(e, _), s = Ie({ type: n2, sealed: o2, iv: r2 });
  return t === ee2 ? Ot(s) : s;
}
function Rr(e, t) {
  const { sealed: n2 } = ne({ encoded: e, encoding: t });
  return toString(n2, _);
}
function Ie(e) {
...
function ne(e) {
  const t = (e.encoding || S) === ee2 ? te(e.encoded) : e.encoded, n2 = fromString(t, S), r2 = n2.slice(br, St), o2 = St;
  if (C2(r2) === D) {
...
function Mt(e, t) {
  ...
  return B(e) ? e.forEach((r2) => {
    n2 || _t(r2) || (n2 = $("UNSUPPORTED_ACCOUNTS", `${t}, account ${r2} should be a string and conform to "namespace:chainId:address" format`));
...
function Ht(e, t, n2) {
  let r2 = null;
  const o2 = io(e), s = co(t), i3 = Object.keys(o2), a2 = Object.keys(s), l = Bt(Object.keys(e)), c2 = Bt(Object.keys(t)), d3 = l.filter((u4) => !c2.includes(u4));
...
function Xt({ publicKey: e, signature: t, payload: n2 }) {
  const r2 = se(n2.method), o2 = 128 | parseInt(n2.version?.toString() || "4"), s = ho(n2.address), i3 = n2.era === "00" ? new Uint8Array([0]) : se(n2.era);
  if (i3.length !== 1 && i3.length !== 2) throw new Error("Invalid era length");
  const a2 = parseInt(n2.nonce, 16), l = new Uint8Array([a2 & 255, a2 >> 8 & 255]), c2 = BigInt(`0x${mo(n2.tip)}`), d3 = yo(c2), u4 = new Uint8Array([0, ...e, s, ...t, ...i3, ...l, ...d3, ...r2]), p4 = go(u4.length + 1);
...
var Qt2 = "0.3";
var Mi = import_time2.FIVE_SECONDS * 1e3;
var te2 = "pairing";
var ee3 = "0.3";
...
var me = class {
  constructor(t, s) {
    this.core = t, this.logger = s, this.keychain = /* @__PURE__ */ new Map(), this.name = $t2, this.version = Ut2, this.initialized = false, this.storagePrefix = S3, this.init = async () => {
      if (!this.initialized) {
...
var _e = class {
  constructor(t, s, i3) {
    this.core = t, this.logger = s, this.name = Kt2, this.randomSessionIdentifier = Nr(), this.initialized = false, this.init = async () => {
      ...
      this.isInitialized();
      const r2 = await this.getClientSeed(), o2 = Po(r2), n2 = this.randomSessionIdentifier, a2 = Mt2;
      return await Qo(n2, e, a2, o2);
    }, this.generateSharedKey = (e, r2, o2) => {
      this.isInitialized();
      const n2 = this.getPrivateKey(e), a2 = vr(n2, r2);
      ...
      if (jr(n2)) return Tr(a2, o2?.encoding);
      if ($r(n2)) {
      ...
      return Ar({ type: d3, symKey: h3, message: a2, senderPublicKey: l, encoding: o2?.encoding });
    }, this.decode = async (e, r2, o2) => {
      this.isInitialized();
      const n2 = Ur(r2, o2);
      if (jr(n2)) {
        const a2 = Rr(r2, o2?.encoding);
      ...
      try {
        const a2 = this.getSymKey(e), h3 = Ir({ symKey: a2, encoded: r2, encoding: o2?.encoding });
  ...
  async getClientSeed() {
    ...
    try {
      ...
      t = Nr(), await this.keychain.set(gt2, t);
    }
...
var be2 = class extends a {
  constructor(t, s) {
    super(t, s), this.logger = t, this.core = s, this.messages = /* @__PURE__ */ new Map(), this.messagesWithoutClientAck = /* @__PURE__ */ new Map(), this.name = qt2, this.version = Vt2, this.initialized = false, this.storagePrefix = S3, this.init = async () => {
      ...
      if (n2[o2] = e, this.messages.set(i3, n2), r2 === H2.inbound) {
...
var Hi = class extends g2 {
  constructor(t, s) {
    super(t, s), this.relayer = t, this.logger = s, this.events = new import_events3.EventEmitter(), this.name = Ft2, this.queue = /* @__PURE__ */ new Map(), this.publishTimeout = (0, import_time2.toMiliseconds)(import_time2.ONE_MINUTE), this.initialPublishTimeout = (0, import_time2.toMiliseconds)(import_time2.ONE_SECOND * 15), this.needsTransportRestart = false, this.publish = async (i3, e, r2) => {
      ...
      const o2 = r2?.ttl || Bt2, n2 = r2?.prompt || false, a2 = r2?.tag || 0, h3 = r2?.id || getBigIntRpcId().toString(), d3 = xr(Pr().protocol), l = { id: h3, method: r2?.publishMethod || d3.publish, params: { topic: i3, message: e, ttl: o2, prompt: n2, tag: a2, attestation: r2?.attestation, ...r2?.tvf } }, g4 = `Failed to publish payload, please try again. id:${h3} tag:${a2}`;
      try {
        ...
        this.logger.trace({ type: "method", method: "publish", params: { id: h3, topic: i3, message: e, opts: r2 } }), await Ln(_3, this.publishTimeout, g4);
      } catch (_3) {
      ...
      const { payload: e, opts: r2 = {} } = i3, { attestation: o2, tvf: n2, publishMethod: a2, prompt: h3, tag: d3, ttl: l = import_time2.FIVE_MINUTES } = r2, g4 = r2.id || getBigIntRpcId().toString(), _3 = xr(Pr().protocol), E4 = a2 || _3.publish, u4 = { id: g4, method: E4, params: { ...e, ttl: l, prompt: h3, tag: d3, attestation: o2, ...n2 } }, N3 = `Failed to publish custom payload, please try again. id:${g4} tag:${d3}`;
      try {
        ...
        const m2 = new Promise(async (C4) => {
          ...
          const Oe2 = Ln(new Promise((L2, Ae3) => {
            this.rpcPublish(u4, r2).then(L2).catch((tt3) => {
              this.logger.warn(tt3, tt3?.message), Ae3(tt3);
            });
        ...
        this.logger.trace({ type: "method", method: "publish", params: { id: g4, payload: e, opts: r2 } }), await Ln(m2, this.publishTimeout, N3);
      } catch (m2) {
...
var we2 = class extends d {
  constructor(t, s) {
    super(t, s), this.relayer = t, this.logger = s, this.subscriptions = /* @__PURE__ */ new Map(), this.topicMap = new Yi(), this.events = new import_events3.EventEmitter(), this.name = Zt2, this.version = Qt2, this.pending = /* @__PURE__ */ new Map(), this.cached = [], this.initialized = false, this.storagePrefix = S3, this.subscribeTimeout = (0, import_time2.toMiliseconds)(import_time2.ONE_MINUTE), this.initialSubscribeTimeout = (0, import_time2.toMiliseconds)(import_time2.ONE_SECOND * 15), this.batchSubscribeTopicsLimit = 500, this.init = async () => {
      ...
      try {
        const r2 = Pr(e), o2 = { topic: i3, relay: r2, transportType: e?.transportType };
  ...
  async rpcSubscribe(t, s, i3) {
    ...
    const r2 = { method: xr(s.protocol).subscribe, params: { topic: t } };
    ...
    try {
      ...
      const n2 = new Promise(async (h3) => {
        ...
        try {
          const l = await Ln(new Promise((g4, _3) => {
      ...
      }), a2 = await Ln(n2, this.subscribeTimeout, `Subscribing to ${t} failed, please try again`);
  ...
  async rpcBatchSubscribe(t) {
    ...
    const s = t[0].relay, i3 = { method: xr(s.protocol).batchSubscribe, params: { topics: t.map((e) => e.topic) } };
    this.logger.debug("Outgoing Relay Payload"), this.logger.trace({ type: "payload", direction: "outgoing", request: i3 });
    try {
      return await Ln(new Promise((e, r2) => {
  ...
  async rpcBatchFetchMessages(t) {
    if (!t.length) return;
    const s = t[0].relay, i3 = { method: xr(s.protocol).batchFetchMessages, params: { topics: t.map((r2) => r2.topic) } };
    this.logger.debug("Outgoing Relay Payload"), this.logger.trace({ type: "payload", direction: "outgoing", request: i3 });
    let e;
    try {
      e = await await Ln(new Promise((r2, o2) => {
  ...
  rpcUnsubscribe(t, s, i3) {
    const e = { method: xr(i3.protocol).unsubscribe, params: { topic: t, id: s } };
  ...
  async batchFetchMessages(t) {
    ...
    s && s.messages && (await Xn((0, import_time2.toMiliseconds)(import_time2.ONE_SECOND)), await this.relayer.handleBatchMessageEvents(s.messages));
  }
  async onConnect() {
...
var fe2 = class extends u {
  constructor(t) {
    ...
    }, this.core = t.core, this.logger = bo({ logger: t.logger ?? Wt2, name: this.name }), this.messages = new be2(this.logger, t.core), this.subscriber = new we2(this, this.logger), this.publisher = new Hi(this, this.logger), this.projectId = t.projectId, this.relayUrl = t.relayUrl || pt2, An() ? this.packageName = Tn() : In() && (this.bundleId = Tn()), this.provider = {};
  }
  async init() {
  ...
  async publish(t, s, i3) {
    this.isInitialized(), await this.publisher.publish(t, s, i3), await this.recordMessageEvent({ topic: t, message: s, publishedAt: Date.now(), transportType: D2.relay }, H2.outbound);
  }
  ...
  async onLinkMessageEvent(t, s) {
    const { topic: i3 } = t;
    if (!s.sessionExists) {
      const e = Hn(import_time2.FIVE_MINUTES), r2 = { topic: i3, expiry: e, relay: { protocol: "irn" }, active: false };
      await this.core.pairing.pairings.set(i3, r2);
    }
    this.events.emit(p2.message, t), await this.recordMessageEvent(t, H2.inbound);
  }
  async connect(t) {
      ...
      for (; s < 6; ) {
        ...
        try {
          ...
          this.logger.debug({}, `Connecting to ${this.relayUrl}, attempt: ${s}...`), await this.createProvider(), await new Promise((i3, e) => {
            ...
            this.provider.once(v3.disconnect, r2), Ln(this.provider.connect(), this.connectTimeout, `Socket stalled when trying to connect to ${this.relayUrl}`).then(() => i3()).catch(e).finally(() => {
  ...
  async createProvider() {
    ...
    this.provider = new o(new f($n({ sdkVersion: Q, protocol: this.protocol, version: this.version, relayUrl: this.relayUrl, projectId: this.projectId, auth: t, useOnCloseEvent: true, bundleId: this.bundleId, packageName: this.packageName }))), this.registerProviderListeners();
  }
  ...
  async onProviderPayload(t) {
    if (this.logger.debug("Incoming Relay Payload"), this.logger.trace({ type: "payload", direction: "incoming", payload: t }), isJsonRpcRequest(t)) {
      if (!t.method.endsWith(Yt2)) return;
  ...
  async onMessageEvent(t) {
    await this.shouldIgnoreMessageEvent(t) || (await this.recordMessageEvent(t, H2.inbound), this.events.emit(p2.message, t));
  }
  ...
  constructor(t, s, i3, e = S3, r2 = void 0) {
    super(t, s, i3, e), this.core = t, this.logger = s, this.name = i3, this.map = /* @__PURE__ */ new Map(), this.version = jt2, this.cached = [], this.initialized = false, this.storagePrefix = S3, this.recentlyDeleted = [], this.recentlyDeletedLimit = 200, this.init = async () => {
      this.initialized || (this.logger.trace("Initialized"), await this.restore(), this.cached.forEach((o2) => {
        this.getKey && o2 !== null && !R(o2) ? this.map.set(this.getKey(o2), o2) : Wr(o2) ? this.map.set(o2.id, o2) : Jr(o2) && this.map.set(o2.topic, o2);
      }), this.cached = [], this.initialized = true);
...
var Ee2 = class {
  constructor(t, s) {
    this.core = t, this.logger = s, this.name = te2, this.version = ee3, this.events = new import_events3.default(), this.initialized = false, this.storagePrefix = S3, this.ignoredPayloadTypes = [D], this.registeredMethods = [], this.init = async () => {
      ...
      this.isInitialized();
      const e = Nr(), r2 = await this.core.crypto.setSymKey(e), o2 = Hn(import_time2.FIVE_MINUTES), n2 = { protocol: Gt2 }, a2 = { topic: r2, expiry: o2, relay: n2, active: false, methods: i3?.methods }, h3 = _r({ protocol: this.core.protocol, version: this.core.version, topic: r2, symKey: e, relay: n2, expiryTimestamp: o2, methods: i3?.methods });
      ...
      const l = a2 || Hn(import_time2.FIVE_MINUTES), g4 = { topic: r2, relay: n2, expiry: l, active: false, methods: h3 };
      ...
      this.isInitialized();
      const e = Hn(import_time2.FIVE_MINUTES);
      ...
      if (this.pairings.keys.includes(e)) {
        const r2 = await this.sendRequest(e, "wc_pairingPing", {}), { done: o2, resolve: n2, reject: a2 } = Mn();
        this.events.once(Wn("pairing_ping", r2), ({ error: h3 }) => {
          h3 ? a2(h3) : n2();
        }), await o2();
      }
      ...
      return _r({ protocol: this.core.protocol, version: this.core.version, topic: e, symKey: a2, relay: r2, expiryTimestamp: o2, methods: n2 });
      ...
      const i3 = this.pairings.getAll().filter((e) => Bn(e.expiry));
      ...
      const { id: r2 } = e;
      setTimeout(() => {
        isJsonRpcResult(e) ? this.events.emit(Wn("pairing_ping", r2), {}) : isJsonRpcError(e) && this.events.emit(Wn("pairing_ping", r2), { error: e.error });
      }, 500);
      ...
      if (Bn(this.pairings.get(i3).expiry)) {
  ...
  registerRelayerEvents() {
    this.core.relayer.on(p2.message, async (t) => {
      ...
      if (this.pairings.keys.includes(s) && e !== D2.link_mode && !this.ignoredPayloadTypes.includes(this.core.crypto.getPayloadType(i3))) try {
...
var Ie2 = class extends h2 {
  constructor(t, s) {
    super(t, s), this.core = t, this.logger = s, this.records = /* @__PURE__ */ new Map(), this.events = new import_events3.EventEmitter(), this.name = ie2, this.version = se2, this.cached = [], this.initialized = false, this.storagePrefix = S3, this.init = async () => {
      ...
      const o2 = { id: e.id, topic: i3, request: { method: e.method, params: e.params || null }, chainId: r2, expiry: Hn(import_time2.THIRTY_DAYS) };
...
var Te2 = class extends x2 {
  ...
  formatTarget(t) {
    ...
    if (typeof t == "number") return Fn2(t);
...
var Pe2 = class extends y2 {
  constructor(t, s, i3) {
    super(t, s, i3), this.core = t, this.logger = s, this.store = i3, this.name = ne2, this.verifyUrlV3 = he2, this.storagePrefix = S3, this.version = lt3, this.init = async () => {
      ...
      let r2 = e || Y2;
      return ce.includes(r2) || (this.logger.info(`verify url: ${r2}, not included in trusted list, assigning default: ${Y2}`), r2 = Y2), r2;
      ...
      const o2 = Cr(e, r2.publicKey), n2 = { hasExpired: (0, import_time2.toMiliseconds)(o2.exp) < Date.now(), payload: o2 };
    ...
    }, this.logger = Re(s, this.name), this.abortController = new AbortController(), this.isDevEnv = Qn(), this.init();
  }
  get storeKey() {
...
var Se2 = class extends C3 {
  constructor(t, s, i3 = true) {
    super(t, s, i3), this.core = t, this.logger = s, this.context = de, this.storagePrefix = S3, this.storageVersion = pe2, this.events = /* @__PURE__ */ new Map(), this.shouldPersist = false, this.init = async () => {
      if (!Qn()) try {
        const e = { eventId: Yn(), timestamp: Date.now(), domain: this.getAppDomain(), props: { event: "INIT", type: "", properties: { client_id: await this.core.crypto.getClientId(), user_agent: Ye(this.core.relayer.protocol, this.core.relayer.version, Q) } } };
        await this.sendEvent([e]);
      } catch (e) {
        this.logger.warn(e);
      }
    }, this.createEvent = (e) => {
      const { event: r2 = "ERROR", type: o2 = "", properties: { topic: n2, trace: a2 } } = e, h3 = Yn(), d3 = this.core.projectId || "", l = Date.now(), g4 = { eventId: h3, timestamp: l, props: { event: r2, type: o2, properties: { topic: n2, trace: a2 } }, bundleId: d3, domain: this.getAppDomain(), ...this.setMethods(h3) };
...
var Ce3 = "WALLETCONNECT_DEEPLINK_CHOICE";
var tt2 = "proposal";
var ke = "Proposal expired";
var st2 = "session";
...
var Es = class extends M2 {
  constructor(a2) {
    super(a2), this.name = it3, this.events = new import_events4.default(), this.initialized = false, this.requestQueue = { state: V2.idle, queue: [] }, this.sessionRequestQueue = { state: V2.idle, queue: [] }, this.emittedSessionRequests = new Zn({ limit: 500 }), this.requestQueueDelay = import_time3.ONE_SECOND, this.expectedPairingMethodMap = /* @__PURE__ */ new Map(), this.recentlyDeletedMap = /* @__PURE__ */ new Map(), this.recentlyDeletedLimit = 200, this.relayMessageCache = [], this.pendingSessions = /* @__PURE__ */ new Map(), this.init = async () => {
      ...
      const { pairingTopic: s, requiredNamespaces: i3, optionalNamespaces: r2, sessionProperties: n2, scopedProperties: o2, relays: c2, authentication: l, walletPay: p4 } = e, g4 = l?.[0]?.ttl || T3.wc_sessionPropose.req.ttl || import_time3.FIVE_MINUTES;
      this.validateRequestExpiry(g4);
      let y5 = s, u4, m2 = false;
      try {
        if (y5) {
      ...
      if (!y5 || !m2) {
        const { topic: E4, uri: A4 } = await this.client.core.pairing.create({ internal: { skipSubscribe: true } });
        y5 = E4, u4 = A4;
      }
      if (!y5) {
      ...
      const h3 = await this.client.core.crypto.generateKeyPair(), w3 = Hn(g4), _3 = { requiredNamespaces: i3, optionalNamespaces: r2, relays: c2 ?? [{ protocol: Gt2 }], proposer: { publicKey: h3, metadata: this.client.metadata }, expiryTimestamp: w3, pairingTopic: y5, ...n2 && { sessionProperties: n2 }, ...o2 && { scopedProperties: o2 }, id: payloadId(), ...(l || p4) && { requests: { authentication: l?.map((E4) => {
        const { domain: A4, chains: K3, nonce: U4, uri: M5, exp: ee5, nbf: oe4, type: te4, statement: ae4, requestId: ge4, resources: R4, signatureTypes: q4 } = E4;
        return { domain: A4, chains: K3, nonce: U4, type: te4 ?? "caip122", aud: M5, version: "1", iat: (/* @__PURE__ */ new Date()).toISOString(), exp: ee5, nbf: oe4, statement: ae4, requestId: ge4, resources: R4, signatureTypes: q4 };
      }), walletPay: p4 } } }, S6 = Wn("session_connect", _3.id), { reject: b4, resolve: O3, done: L2 } = Mn(g4, ke), P3 = ({ id: E4 }) => {
        if (E4 === _3.id) {
          this.client.events.off("proposal_expire", P3);
          const A4 = this.pendingSessions.get(_3.id);
          if (A4) {
            const { sessionTopic: K3, publicKey: U4 } = A4;
            Promise.all([this.client.core.relayer.unsubscribe(K3), this.client.core.crypto.keychain.has(K3) ? this.client.core.crypto.deleteSymKey(K3) : Promise.resolve(), this.client.core.crypto.keychain.has(U4) ? this.client.core.crypto.deleteKeyPair(U4) : Promise.resolve()]).catch((M5) => this.client.logger.warn(M5));
          }
          this.pendingSessions.delete(_3.id), this.events.emit(S6, { error: { message: ke, code: 0 } });
        }
      };
      return this.client.events.on("proposal_expire", P3), this.events.once(S6, ({ error: E4, session: A4 }) => {
        this.client.events.off("proposal_expire", P3), E4 ? b4(E4) : A4 && O3(A4);
      ...
      const e = this.client.core.eventClient.createEvent({ properties: { topic: t?.id?.toString(), trace: [Bi.session_approve_started] } });
      try {
        this.isInitialized(), await this.confirmOnlineStateOrThrow();
      } catch (P3) {
        throw e.setError(Fi.no_internet_connection), P3;
      }
      try {
        await this.isValidProposalId(t?.id);
      } catch (P3) {
        throw this.client.logger.error(`approve() -> proposal.get(${t?.id}) failed`), e.setError(Fi.proposal_not_found), P3;
      }
      try {
        await this.isValidApprove(t);
      } catch (P3) {
        throw this.client.logger.error("approve() -> isValidApprove() failed"), e.setError(Fi.session_approve_namespace_validation_failure), P3;
      }
      const { id: s, relayProtocol: i3, namespaces: r2, sessionProperties: n2, scopedProperties: o2, sessionConfig: c2, proposalRequestsResponses: l } = t, p4 = this.client.proposal.get(s);
      this.client.core.eventClient.deleteEvent({ eventId: e.eventId });
      const { pairingTopic: g4, proposer: y5, requiredNamespaces: u4, optionalNamespaces: m2 } = p4;
      let h3 = this.client.core.eventClient?.getEvent({ topic: g4 });
      h3 || (h3 = this.client.core.eventClient?.createEvent({ type: Bi.session_approve_started, properties: { topic: g4, trace: [Bi.session_approve_started, Bi.session_namespaces_validation_success] } }));
      const w3 = await this.client.core.crypto.generateKeyPair(), _3 = y5.publicKey, S6 = await this.client.core.crypto.generateSharedKey(w3, _3), b4 = { relay: { protocol: i3 ?? "irn" }, namespaces: r2, controller: { publicKey: w3, metadata: this.client.metadata }, expiry: Hn(Z2), ...n2 && { sessionProperties: n2 }, ...o2 && { scopedProperties: o2 }, ...c2 && { sessionConfig: c2 }, proposalRequestsResponses: l }, O3 = D2.relay;
      h3.addTrace(Bi.subscribing_session_topic);
      try {
        await this.client.core.relayer.subscribe(S6, { transportType: O3, internal: { skipSubscribe: true } });
      } catch (P3) {
        throw h3.setError(Fi.subscribe_session_topic_failure), P3;
      }
      h3.addTrace(Bi.subscribe_session_topic_success);
      const L2 = { ...b4, topic: S6, requiredNamespaces: u4, optionalNamespaces: m2, pairingTopic: g4, acknowledged: false, self: b4.controller, peer: { publicKey: y5.publicKey, metadata: y5.metadata }, controller: w3, transportType: D2.relay, authentication: l?.authentication, walletPayResult: l?.walletPay };
      await this.client.session.set(S6, L2), h3.addTrace(Bi.store_session);
      try {
        await this.sendApproveSession({ sessionTopic: S6, proposal: p4, pairingProposalResponse: { relay: { protocol: i3 ?? "irn" }, responderPublicKey: w3 }, sessionSettleRequest: b4, publishOpts: { internal: { throwOnFailedPublish: true }, tvf: { correlationId: s, ...this.getTVFApproveParams(L2) } } }), h3.addTrace(Bi.session_approve_publish_success);
      } catch (P3) {
      ...
      return this.client.core.eventClient.deleteEvent({ eventId: h3.eventId }), await this.client.core.pairing.updateMetadata({ topic: g4, metadata: y5.metadata }), await this.deleteProposal(s), await this.client.core.pairing.activate({ topic: g4 }), await this.setExpiry(S6, Hn(Z2)), { topic: S6, acknowledged: () => Promise.resolve(this.client.session.get(S6)) };
    }, this.reject = async (t) => {
      this.isInitialized(), await this.confirmOnlineStateOrThrow();
      try {
      ...
      const { topic: e, namespaces: s } = t, { done: i3, resolve: r2, reject: n2 } = Mn(import_time3.FIVE_MINUTES, "Session update request expired without receiving any acknowledgement"), o2 = payloadId(), c2 = getBigIntRpcId().toString(), l = this.client.session.get(e).namespaces;
      return this.events.once(Wn("session_update", o2), ({ error: p4 }) => {
        p4 ? n2(p4) : r2();
      }), await this.client.session.update(e, { namespaces: s }), await this.sendRequest({ topic: e, method: "wc_sessionUpdate", params: { namespaces: s }, throwOnFailedPublish: true, clientRpcId: o2, relayRpcId: c2 }).catch((p4) => {
        this.client.logger.error(p4), this.client.session.update(e, { namespaces: l }), n2(p4);
      }), { acknowledged: i3 };
    }, this.extend = async (t) => {
      this.isInitialized(), await this.confirmOnlineStateOrThrow();
      try {
      ...
      const { topic: e } = t, s = payloadId(), { done: i3, resolve: r2, reject: n2 } = Mn(import_time3.FIVE_MINUTES, "Session extend request expired without receiving any acknowledgement");
      return this.events.once(Wn("session_extend", s), ({ error: o2 }) => {
        o2 ? n2(o2) : r2();
      }), await this.setExpiry(e, Hn(Z2)), this.sendRequest({ topic: e, method: "wc_sessionExtend", params: {}, clientRpcId: s, throwOnFailedPublish: true }).catch((o2) => {
        n2(o2);
      }), { acknowledged: i3 };
      ...
      const o2 = payloadId(), c2 = getBigIntRpcId().toString(), { done: l, resolve: p4, reject: g4 } = Mn(r2, "Request expired. Please try again.");
      this.events.once(Wn("session_request", o2), ({ error: h3, result: w3 }) => {
        h3 ? g4(h3) : p4(w3);
      });
      const y5 = "wc_sessionRequest", u4 = this.getAppLinkIfEnabled(n2.peer.metadata, n2.transportType);
      if (u4) return await this.sendRequest({ clientRpcId: o2, relayRpcId: c2, topic: i3, method: y5, params: { request: { ...s, expiryTimestamp: Hn(r2) }, chainId: e }, expiry: r2, throwOnFailedPublish: true, appLink: u4 }).catch((h3) => g4(h3)), this.client.events.emit("session_request_sent", { topic: i3, request: s, chainId: e, id: o2 }), await l();
      const m2 = { request: { ...s, expiryTimestamp: Hn(r2) }, chainId: e };
      return await Promise.all([new Promise(async (h3) => {
        await this.sendRequest({ clientRpcId: o2, relayRpcId: c2, topic: i3, method: y5, params: m2, expiry: r2, throwOnFailedPublish: true, tvf: this.getTVFParams(o2, m2) }).catch((w3) => g4(w3)), this.client.events.emit("session_request_sent", { topic: i3, request: s, chainId: e, id: o2 }), h3();
      }), new Promise(async (h3) => {
        if (!n2.sessionConfig?.disableDeepLink) {
          const w3 = await zn(this.client.core.storage, Ce3);
          await Jn({ id: o2, topic: i3, wcDeepLink: w3 });
        }
        h3();
      }), l()]).then((h3) => h3[2]);
    }, this.respond = async (t) => {
      this.isInitialized();
      const e = this.client.core.eventClient.createEvent({ properties: { topic: t?.topic || t?.response?.id?.toString(), trace: [Bi.session_request_response_started] } });
      try {
        await this.isValidRespond(t);
      } catch (c2) {
        throw e.addTrace(c2?.message), e.setError(Fi.session_request_response_validation_failure), c2;
      }
      ...
      try {
        e.addTrace(Bi.session_request_response_publish_started), isJsonRpcResult(i3) ? await this.sendResult({ id: r2, topic: s, result: i3.result, throwOnFailedPublish: true, appLink: o2 }) : isJsonRpcError(i3) && await this.sendError({ id: r2, topic: s, error: i3.error, appLink: o2 }), this.cleanupAfterResponse(t);
      } catch (c2) {
        throw e.addTrace(c2?.message), e.setError(Fi.session_request_response_publish_failure), c2;
      }
    }, this.ping = async (t) => {
      this.isInitialized(), await this.confirmOnlineStateOrThrow();
      try {
      ...
      if (this.client.session.keys.includes(e)) {
        const s = payloadId(), i3 = getBigIntRpcId().toString(), { done: r2, resolve: n2, reject: o2 } = Mn(import_time3.FIVE_MINUTES, "Ping request expired without receiving any acknowledgement");
        this.events.once(Wn("session_ping", s), ({ error: c2 }) => {
          c2 ? o2(c2) : n2();
      ...
      const { chains: r2, statement: n2 = "", uri: o2, domain: c2, nonce: l, type: p4, exp: g4, nbf: y5, methods: u4 = [], expiry: m2 } = t, h3 = [...t.resources || []], { topic: w3, uri: _3 } = await this.client.core.pairing.create({ methods: ["wc_sessionAuthenticate"], transportType: i3 });
      if (this.client.logger.info({ message: "Generated new pairing", pairing: { topic: w3, uri: _3 } }), this.client.auth.authKeys.keys.includes($2)) {
        const { responseTopic: R4, publicKey: q4 } = this.client.auth.authKeys.get($2);
        R4 && (await this.client.core.relayer.unsubscribe(R4).catch((x6) => this.client.logger.warn(x6)), await this.client.auth.pairingTopics.delete(R4, { message: "replaced", code: 0 }).catch((x6) => this.client.logger.warn(x6))), q4 && this.client.core.crypto.keychain.has(q4) && await this.client.core.crypto.deleteKeyPair(q4);
      }
      const S6 = await this.client.core.crypto.generateKeyPair(), b4 = Sr(S6);
      if (await Promise.all([this.client.auth.authKeys.set($2, { responseTopic: b4, publicKey: S6 }), this.client.auth.pairingTopics.set(b4, { topic: b4, pairingTopic: w3 })]), await this.client.core.relayer.subscribe(b4, { transportType: i3 }), this.client.logger.info(`sending request to new pairing topic: ${w3}`), u4.length > 0) {
        const { namespace: R4 } = ae(r2[0]);
        let q4 = hr(R4, "request", u4);
        Z(h3) && (q4 = gr(q4, h3.pop())), h3.push(q4);
      }
      const O3 = m2 && m2 > T3.wc_sessionAuthenticate.req.ttl ? m2 : T3.wc_sessionAuthenticate.req.ttl, L2 = { authPayload: { type: p4 ?? "caip122", chains: r2, statement: n2, aud: o2, domain: c2, version: "1", nonce: l, iat: (/* @__PURE__ */ new Date()).toISOString(), exp: g4, nbf: y5, resources: h3 }, requester: { publicKey: S6, metadata: this.client.metadata }, expiryTimestamp: Hn(O3) }, P3 = { eip155: { chains: r2, methods: [.../* @__PURE__ */ new Set(["personal_sign", ...u4])], events: ["chainChanged", "accountsChanged"] } }, E4 = { requiredNamespaces: {}, optionalNamespaces: P3, relays: [{ protocol: "irn" }], pairingTopic: w3, proposer: { publicKey: S6, metadata: this.client.metadata }, expiryTimestamp: Hn(T3.wc_sessionPropose.req.ttl), id: payloadId() }, { done: A4, resolve: K3, reject: U4 } = Mn(O3, "Request expired"), M5 = payloadId(), ee5 = Wn("session_connect", E4.id), oe4 = Wn("session_request", M5), te4 = async ({ error: R4, session: q4 }) => {
        this.events.off(oe4, ae4), R4 ? U4(R4) : q4 && K3({ session: q4 });
      }, ae4 = async (R4) => {
        if (await this.deletePendingAuthRequest(M5, { message: "fulfilled", code: 0 }), R4.error) {
          const le3 = $("WC_METHOD_UNSUPPORTED", "wc_sessionAuthenticate");
          return R4.error.code === le3.code ? void 0 : (this.events.off(ee5, te4), U4(R4.error.message));
        }
        await this.deleteProposal(E4.id), this.events.off(ee5, te4);
        const { cacaos: q4, responder: x6 } = R4.result, Ee3 = [], Ve = [];
        for (const le3 of q4) {
          await lr({ cacao: le3, projectId: this.client.core.projectId }) || (this.client.logger.error(le3, "Signature verification failed"), U4($("SESSION_SETTLEMENT_FAILED", "Signature verification failed")));
          const { p: Re4 } = le3, Ie3 = Z(Re4.resources), Le = [ft(Re4.iss)], yt3 = Ee(Re4.iss);
          if (Ie3) {
            const Te3 = yr(Ie3), wt = Er(Ie3);
            Ee3.push(...Te3), Le.push(...wt);
          }
          for (const Te3 of Le) Ve.push(`${Te3}:${yt3}`);
        }
        const ce3 = await this.client.core.crypto.generateSharedKey(S6, x6.publicKey);
        let ye3;
        Ee3.length > 0 && (ye3 = { topic: ce3, acknowledged: true, self: { publicKey: S6, metadata: this.client.metadata }, peer: x6, controller: x6.publicKey, expiry: Hn(Z2), requiredNamespaces: {}, optionalNamespaces: {}, relay: { protocol: "irn" }, pairingTopic: w3, namespaces: Fr2([...new Set(Ee3)], [...new Set(Ve)]), transportType: i3 }, await this.client.core.relayer.subscribe(ce3, { transportType: i3 }), await this.client.session.set(ce3, ye3), w3 && await this.client.core.pairing.updateMetadata({ topic: w3, metadata: x6.metadata }), ye3 = this.client.session.get(ce3)), this.client.metadata.redirect?.linkMode && x6.metadata.redirect?.linkMode && x6.metadata.redirect?.universal && e && (this.client.core.addLinkModeSupportedApp(x6.metadata.redirect.universal), this.client.session.update(ce3, { transportType: D2.link_mode })), K3({ auths: q4, session: ye3 });
      };
      this.events.once(ee5, te4), this.events.once(oe4, ae4);
      let ge4;
      try {
        if (s) {
          ...
          ge4 = Dr(e, w3, q4);
        } else await Promise.all([this.sendRequest({ topic: w3, method: "wc_sessionAuthenticate", params: L2, expiry: t.expiry, throwOnFailedPublish: true, clientRpcId: M5 }), this.sendRequest({ topic: w3, method: "wc_sessionPropose", params: E4, expiry: T3.wc_sessionPropose.req.ttl, throwOnFailedPublish: true, clientRpcId: E4.id })]);
      } catch (R4) {
        throw this.events.off(ee5, te4), this.events.off(oe4, ae4), R4;
      }
      return await this.setProposal(E4.id, E4), await this.setAuthRequest(M5, { request: { ...L2, verifyContext: {} }, pairingTopic: w3, transportType: i3 }), { uri: ge4 ?? _3, response: A4 };
    }, this.approveSessionAuthenticate = async (t) => {
      const { id: e, auths: s } = t, i3 = this.client.core.eventClient.createEvent({ properties: { topic: e.toString(), trace: [Gi.authenticated_session_approve_started] } });
      try {
        this.isInitialized();
      } catch (h3) {
        throw i3.setError(Wi.no_internet_connection), h3;
      }
      const r2 = this.getPendingAuthRequest(e);
      if (!r2) throw i3.setError(Wi.authenticated_session_pending_request_not_found), new Error(`Could not find pending auth request with id ${e}`);
      const n2 = r2.transportType || D2.relay;
      n2 === D2.relay && await this.confirmOnlineStateOrThrow();
      const o2 = r2.requester.publicKey, c2 = await this.client.core.crypto.generateKeyPair(), l = Sr(o2), p4 = { type: D, receiverPublicKey: o2, senderPublicKey: c2 }, g4 = [], y5 = [];
      for (const h3 of s) {
        if (!await lr({ cacao: h3, projectId: this.client.core.projectId })) {
          i3.setError(Wi.invalid_cacao);
          const O3 = $("SESSION_SETTLEMENT_FAILED", "Signature verification failed");
          throw await this.sendError({ id: e, topic: l, error: O3, encodeOpts: p4 }), new Error(O3.message);
        }
        i3.addTrace(Gi.cacaos_verified);
        const { p: w3 } = h3, _3 = Z(w3.resources), S6 = [ft(w3.iss)], b4 = Ee(w3.iss);
        if (_3) {
          const O3 = yr(_3), L2 = Er(_3);
          g4.push(...O3), S6.push(...L2);
        }
        for (const O3 of S6) y5.push(`${O3}:${b4}`);
      }
      const u4 = await this.client.core.crypto.generateSharedKey(c2, o2);
      i3.addTrace(Gi.create_authenticated_session_topic);
      let m2;
      if (g4?.length > 0) {
        m2 = { topic: u4, acknowledged: true, self: { publicKey: c2, metadata: this.client.metadata }, peer: { publicKey: o2, metadata: r2.requester.metadata }, controller: o2, expiry: Hn(Z2), authentication: s, requiredNamespaces: {}, optionalNamespaces: {}, relay: { protocol: "irn" }, pairingTopic: r2.pairingTopic, namespaces: Fr2([...new Set(g4)], [...new Set(y5)]), transportType: n2 }, i3.addTrace(Gi.subscribing_authenticated_session_topic);
        try {
          await this.client.core.relayer.subscribe(u4, { transportType: n2 });
        } catch (h3) {
          throw i3.setError(Wi.subscribe_authenticated_session_topic_failure), h3;
        }
        i3.addTrace(Gi.subscribe_authenticated_session_topic_success), await this.client.session.set(u4, m2), i3.addTrace(Gi.store_authenticated_session), await this.client.core.pairing.updateMetadata({ topic: r2.pairingTopic, metadata: r2.requester.metadata });
      }
      i3.addTrace(Gi.publishing_authenticated_session_approve);
      try {
        await this.sendResult({ topic: l, id: e, result: { cacaos: s, responder: { publicKey: c2, metadata: this.client.metadata } }, encodeOpts: p4, throwOnFailedPublish: true, appLink: this.getAppLinkIfEnabled(r2.requester.metadata, n2) });
      } catch (h3) {
        throw i3.setError(Wi.authenticated_session_approve_publish_failure), h3;
      }
      ...
      const r2 = i3.requester.publicKey, n2 = await this.client.core.crypto.generateKeyPair(), o2 = Sr(r2), c2 = { type: D, receiverPublicKey: r2, senderPublicKey: n2 };
      ...
      await Promise.all([this.client.pendingRequest.delete(t, e), s ? Promise.resolve() : this.client.core.expirer.del(t)]), this.addToRecentlyDeleted(t, "request"), this.sessionRequestQueue.queue = this.sessionRequestQueue.queue.filter((i3) => i3.id !== t), s && (this.sessionRequestQueue.state = V2.idle, this.client.events.emit("session_request_expire", { id: t }));
      ...
      this.client.core.expirer.set(t, Hn(T3.wc_sessionPropose.req.ttl)), await this.client.proposal.set(t, e);
      ...
      const { id: e, topic: s, params: i3, verifyContext: r2 } = t, n2 = i3.request.expiryTimestamp || Hn(T3.wc_sessionRequest.req.ttl);
      this.client.core.expirer.set(e, n2), await this.client.pendingRequest.set(e, { id: e, topic: s, params: i3, verifyContext: r2 });
    }, this.sendRequest = async (t) => {
      const { topic: e, method: s, params: i3, expiry: r2, relayRpcId: n2, clientRpcId: o2, throwOnFailedPublish: c2, appLink: l, tvf: p4, publishOpts: g4 = {} } = t, y5 = formatJsonRpcRequest(s, i3, o2);
      let u4;
      const m2 = !!l;
      try {
        const _3 = m2 ? ee2 : S;
        u4 = await this.client.core.crypto.encode(e, y5, { encoding: _3 });
      } catch (_3) {
        throw await this.cleanup(), this.client.logger.error(`sendRequest() -> core.crypto.encode() for topic ${e} failed`), _3;
      }
      let h3;
      if (ot2.includes(s)) {
        const _3 = Or(JSON.stringify(y5)), S6 = Or(u4);
        h3 = await this.client.core.verify.register({ id: S6, decryptedId: _3 });
      }
      const w3 = { ...T3[s].req, ...g4 };
      ...
      } else w3.tvf = { ...p4, correlationId: y5.id }, c2 ? (w3.internal = { ...w3.internal, throwOnFailedPublish: true }, await this.client.core.relayer.publish(e, u4, w3)) : this.client.core.relayer.publish(e, u4, w3).catch((_3) => this.client.logger.error(_3));
      return y5.id;
      ...
      const r2 = await this.client.core.crypto.encode(e.pairingTopic, i3, { encoding: S }), n2 = Or(JSON.stringify(i3)), o2 = Or(r2), c2 = await this.client.core.verify.register({ id: o2, decryptedId: n2 });
      ...
      const { sessionTopic: e, pairingProposalResponse: s, proposal: i3, sessionSettleRequest: r2, publishOpts: n2 } = t, o2 = formatJsonRpcResult(i3.id, s), c2 = await this.client.core.crypto.encode(i3.pairingTopic, o2, { encoding: S }), l = formatJsonRpcRequest("wc_sessionSettle", r2, n2?.id), p4 = await this.client.core.crypto.encode(e, l, { encoding: S });
      this.client.core.history.set(e, l), await this.client.core.relayer.publishCustom({ payload: { sessionTopic: e, pairingTopic: i3.pairingTopic, sessionProposalResponse: c2, sessionSettlementRequest: p4 }, opts: { ...n2, publishMethod: "wc_approveSession" } });
    }, this.sendResult = async (t) => {
      const { id: e, topic: s, result: i3, throwOnFailedPublish: r2, encodeOpts: n2, appLink: o2 } = t, c2 = formatJsonRpcResult(e, i3);
      let l;
      const p4 = o2 && typeof global?.Linking < "u";
      try {
        const u4 = p4 ? ee2 : S;
        l = await this.client.core.crypto.encode(s, c2, { ...n2 || {}, encoding: u4 });
      } catch (u4) {
        throw await this.cleanup(), this.client.logger.error(`sendResult() -> core.crypto.encode() for topic ${s} failed`), u4;
      }
      let g4, y5;
      try {
        g4 = await this.client.core.history.get(s, e);
        const u4 = g4.request;
        try {
          y5 = this.getTVFParams(e, u4.params, i3);
        } catch (m2) {
          this.client.logger.warn(`sendResult() -> getTVFParams() failed: ${m2?.message}`);
        }
      } catch (u4) {
        throw this.client.logger.error(`sendResult() -> history.get(${s}, ${e}) failed`), u4;
      }
      if (p4) {
        const u4 = Dr(o2, s, l);
        await global.Linking.openURL(u4, this.client.name);
      } else {
        const u4 = g4.request.method, m2 = T3[u4].res;
      ...
      if (p4) {
        ...
        const y5 = g4.request.method, u4 = n2 || T3[y5].res;
        this.client.core.relayer.publish(s, l, u4);
      }
      await this.client.core.history.resolve(c2);
    }, this.cleanup = async () => {
      const t = [], e = [];
      this.client.session.getAll().forEach((s) => {
        let i3 = false;
        Bn(s.expiry) && (i3 = true), this.client.core.crypto.keychain.has(s.topic) || (i3 = true), i3 && t.push(s.topic);
      ...
      for (this.client.logger.info(`Request queue starting with ${this.requestQueue.queue.length} requests`); this.requestQueue.queue.length > 0; ) {
        this.requestQueue.state = V2.active;
      ...
      this.requestQueue.state = V2.idle;
      ...
      try {
        ...
        const l = n2.expiryTimestamp || Hn(T3.wc_sessionPropose.req.ttl), p4 = { id: o2, pairingTopic: e, expiryTimestamp: l, attestation: i3, encryptedId: r2, ...n2 };
        await this.setProposal(o2, p4);
        const g4 = await this.getVerifyContext({ attestationId: i3, hash: Or(JSON.stringify(s)), encryptedId: r2, metadata: p4.proposer.metadata });
        c2?.addTrace(x3.emit_session_proposal), this.client.events.emit("session_proposal", { id: o2, params: p4, verifyContext: g4 });
      } catch (c2) {
      ...
      if (isJsonRpcResult(e)) {
        ...
        const p4 = await this.client.core.relayer.subscribe(l, { transportType: s });
        this.client.logger.trace({ type: "method", method: "onSessionProposeResponse", subscriptionId: p4 }), await this.client.core.pairing.activate({ topic: t });
      } else if (isJsonRpcError(e)) {
        await this.deleteProposal(i3);
        const r2 = Wn("session_connect", i3);
      ...
      try {
        ...
        const { relay: r2, controller: n2, expiry: o2, namespaces: c2, sessionProperties: l, scopedProperties: p4, sessionConfig: g4, proposalRequestsResponses: y5 } = e.params, u4 = [...this.pendingSessions.values()].find((w3) => w3.sessionTopic === t);
        if (!u4) return this.client.logger.error(`Pending session not found for topic ${t}`);
        const m2 = this.client.proposal.get(u4.proposalId), h3 = { topic: t, relay: r2, expiry: o2, namespaces: c2, acknowledged: true, pairingTopic: u4.pairingTopic, requiredNamespaces: m2.requiredNamespaces, optionalNamespaces: m2.optionalNamespaces, controller: n2.publicKey, self: { publicKey: u4.publicKey, metadata: this.client.metadata }, peer: { publicKey: n2.publicKey, metadata: n2.metadata }, ...l && { sessionProperties: l }, ...p4 && { scopedProperties: p4 }, ...g4 && { sessionConfig: g4 }, transportType: D2.relay, authentication: y5?.authentication, walletPayResult: y5?.walletPay };
        await this.client.session.set(h3.topic, h3), await this.setExpiry(h3.topic, h3.expiry), await this.client.core.pairing.updateMetadata({ topic: u4.pairingTopic, metadata: h3.peer.metadata }), this.pendingSessions.delete(u4.proposalId), this.deleteProposal(u4.proposalId, false), this.cleanupDuplicatePairings(h3), await this.sendResult({ id: e.id, topic: t, throwOnFailedPublish: true, result: true }), this.client.events.emit("session_connect", { session: h3 }), this.events.emit(Wn("session_connect", u4.proposalId), { session: h3 });
      } catch (r2) {
        await this.sendError({ id: s, topic: t, error: r2 }), this.client.logger.error(r2);
      }
    }, this.onSessionSettleResponse = async (t, e) => {
      const { id: s } = e;
      isJsonRpcResult(e) ? (await this.client.session.update(t, { acknowledged: true }), this.events.emit(Wn("session_approve", s), {})) : isJsonRpcError(e) && (await this.deleteSession({ topic: t, emitEvent: false }), this.events.emit(Wn("session_approve", s), { error: e.error }));
    }, this.onSessionUpdateRequest = async (t, e) => {
      const { params: s, id: i3 } = e;
      try {
        const r2 = `${t}_session_update`, n2 = po.get(r2);
        ...
        this.isValidUpdate({ topic: t, ...s });
        try {
          po.set(r2, i3), await this.client.session.update(t, { namespaces: s.namespaces }), await this.sendResult({ id: i3, topic: t, result: true });
        } catch (o2) {
          throw po.delete(r2), o2;
        }
      ...
      const { id: s } = e, i3 = Wn("session_update", s);
      ...
      const { id: s } = e;
      try {
        this.isValidExtend({ topic: t }), await this.setExpiry(t, Hn(Z2)), await this.sendResult({ id: s, topic: t, result: true }), this.client.events.emit("session_extend", { id: s, topic: t });
      } catch (i3) {
        await this.sendError({ id: s, topic: t, error: i3 }), this.client.logger.error(i3);
      }
    }, this.onSessionExtendResponse = (t, e) => {
      const { id: s } = e, i3 = Wn("session_extend", s);
      if (this.events.listenerCount(i3) === 0) throw new Error(`emitting ${i3} without any listeners`);
      ...
      const { id: s } = e, i3 = Wn("session_ping", s);
      setTimeout(() => {
      ...
      try {
        ...
        const l = this.client.session.get(e), p4 = await this.getVerifyContext({ attestationId: i3, hash: Or(JSON.stringify(formatJsonRpcRequest("wc_sessionRequest", c2, o2))), encryptedId: r2, metadata: l.peer.metadata, transportType: n2 }), g4 = { id: o2, topic: e, params: c2, verifyContext: p4 };
        await this.setPendingSessionRequest(g4), n2 === D2.link_mode && l.peer.metadata.redirect?.universal && this.client.core.addLinkModeSupportedApp(l.peer.metadata.redirect?.universal), this.client.signConfig?.disableRequestQueue ? this.emitSessionRequest(g4) : (this.addSessionRequestToSessionRequestQueue(g4), this.processSessionRequestQueue());
      } catch (l) {
        await this.sendError({ id: o2, topic: e, error: l }), this.client.logger.error(l);
      }
    }, this.onSessionRequestResponse = (t, e) => {
      const { id: s } = e, i3 = Wn("session_request", s);
      if (this.events.listenerCount(i3) === 0) throw new Error(`emitting ${i3} without any listeners`);
      ...
      const { id: s, params: i3 } = e;
      try {
        const r2 = `${t}_session_event_${i3.event.name}`, n2 = po.get(r2);
        if (n2 && this.isRequestOutOfSync(n2, s)) {
          this.client.logger.info(`Discarding out of sync request - ${s}`);
          return;
        }
        this.isValidEmit({ topic: t, ...i3 }), this.client.events.emit("session_event", { id: s, topic: t, params: i3 }), po.set(r2, s);
      } catch (r2) {
        await this.sendError({ id: s, topic: t, error: r2 }), this.client.logger.error(r2);
      }
    }, this.onSessionAuthenticateResponse = (t, e) => {
      const { id: s } = e;
      this.client.logger.trace({ type: "method", method: "onSessionAuthenticateResponse", topic: t, payload: e }), isJsonRpcResult(e) ? this.events.emit(Wn("session_request", s), { result: e.result }) : isJsonRpcError(e) && this.events.emit(Wn("session_request", s), { error: e.error });
    }, this.onSessionAuthenticateRequest = async (t) => {
      const { topic: e, payload: s, attestation: i3, encryptedId: r2, transportType: n2 } = t;
      try {
        const { requester: o2, authPayload: c2, expiryTimestamp: l } = s.params, p4 = await this.getVerifyContext({ attestationId: i3, hash: Or(JSON.stringify(s)), encryptedId: r2, metadata: o2.metadata, transportType: n2 }), g4 = { requester: o2, pairingTopic: e, id: s.id, authPayload: c2, verifyContext: p4, expiryTimestamp: l };
        await this.setAuthRequest(s.id, { request: g4, pairingTopic: e, transportType: n2 }), n2 === D2.link_mode && o2.metadata.redirect?.universal && this.client.core.addLinkModeSupportedApp(o2.metadata.redirect.universal), this.client.events.emit("session_authenticate", { topic: e, params: s.params, id: s.id, verifyContext: p4 });
      } catch (o2) {
        this.client.logger.error(o2);
        const c2 = s.params.requester.publicKey, l = await this.client.core.crypto.generateKeyPair(), p4 = this.getAppLinkIfEnabled(s.params.requester.metadata, n2), g4 = { type: D, receiverPublicKey: c2, senderPublicKey: l };
        await this.sendError({ id: s.id, topic: e, error: o2, encodeOpts: g4, rpcOpts: T3.wc_sessionAuthenticate.autoReject, appLink: p4 });
      }
    }, this.addSessionRequestToSessionRequestQueue = (t) => {
      this.sessionRequestQueue.queue.push(t);
    }, this.cleanupAfterResponse = (t) => {
      this.deletePendingSessionRequest(t.response.id, { message: "fulfilled", code: 0 }), setTimeout(() => {
        this.sessionRequestQueue.state = V2.idle, this.processSessionRequestQueue();
      }, (0, import_time3.toMiliseconds)(this.requestQueueDelay));
      ...
      s.length > 0 && s.filter((i3) => i3.topic === t && i3.request.method === "wc_sessionRequest").forEach((i3) => {
        this.events.emit(Wn("session_request", i3.request.id), { error: e });
      });
    }, this.processSessionRequestQueue = () => {
      if (this.sessionRequestQueue.state === V2.active) {
      ...
      this.sessionRequestQueue.state = V2.active, this.emittedSessionRequests.add(t.id), this.client.events.emit("session_request", t);
      ...
      let r2;
      if (this.client.auth.authKeys.keys.includes($2)) {
        const { responseTopic: n2 } = this.client.auth.authKeys.get($2);
        r2 = n2;
      }
      ...
      if (R(e) || await this.isValidPairingTopic(e), !Yr(o2, true)) {
      ...
      if (!Xr(t)) throw new Error(N("MISSING_OR_INVALID", `approve() params: ${t}`).message);
      ...
      if (!E(i3, true)) {
        const { message: p4 } = N("MISSING_OR_INVALID", `approve() relayProtocol: ${i3}`);
        throw new Error(p4);
      }
      if (r2 && !R(r2) && this.validateSessionProps(r2, "sessionProperties"), n2 && !R(n2)) {
        this.validateSessionProps(n2, "scopedProperties");
        const p4 = new Set(Object.keys(s));
        if (!Object.keys(n2).every((g4) => p4.has(g4.split(":")[0]))) throw new Error(`Scoped properties must be a subset of approved namespaces, received: ${JSON.stringify(n2)}, approved namespaces: ${Array.from(p4).join(", ")}`);
      }
      ...
      const n2 = zr(s, "onSessionSettleRequest()");
      ...
      const { attestationId: e, hash: s, encryptedId: i3, metadata: r2, transportType: n2 } = t, o2 = { verified: { verifyUrl: r2.verifyUrl || Y2, validation: "UNKNOWN", origin: r2.url || "" } };
      try {
        if (n2 === D2.link_mode) {
      ...
      const e = Gn(t, "topic") || "", s = decodeURIComponent(Gn(t, "wc_ev") || ""), i3 = this.client.session.keys.includes(e);
      ...
      if (Qn() || A() && this.client.metadata.redirect?.linkMode) {
      ...
      try {
        const e = jt(t.namespaces), s = Vr(t.namespaces), i3 = Mr(t.namespaces), r2 = t.sessionProperties, n2 = t.scopedProperties;
      ...
      try {
        if (!e) return [];
        const s = t.method, i3 = rt2[s];
        if (s === "sui_signTransaction") return [rr(e.transactionBytes)];
        if (s === "near_signTransaction") return [or(e)];
        if (s === "near_signTransactions") return e.map((n2) => or(n2));
        if (s === "xrpl_signTransactionFor" || s === "xrpl_signTransaction") return [e.tx_json?.hash];
        if (s === "polkadot_signTransaction") return [Eo({ transaction: t.params.transactionPayload, signature: e.signature })];
        if (s === "algo_signTxn") return B(e) ? e.map((n2) => sr(n2)) : [sr(e)];
        if (s === "cosmos_signDirect") return [ir(e)];
        if (s === "wallet_sendCalls") return cr(e);
        if (typeof e == "string") return [e];
        const r2 = e[i3.key];
        if (B(r2)) return s === "solana_signAllTransactions" ? r2.map((n2) => nr(n2)) : r2;
  ...
  async onRelayMessage(a2) {
    const { topic: t, message: e, attestation: s, transportType: i3 } = a2, { publicKey: r2 } = this.client.auth.authKeys.keys.includes($2) ? this.client.auth.authKeys.get($2) : { publicKey: void 0 };
    try {
      const n2 = await this.client.core.crypto.decode(t, e, { receiverPublicKey: r2, encoding: i3 === D2.link_mode ? ee2 : S });
      isJsonRpcRequest(n2) ? (this.client.core.history.set(t, n2), await this.onRelayEventRequest({ topic: t, payload: n2, attestation: s, transportType: i3, encryptedId: Or(e) })) : isJsonRpcResponse(n2) ? (await this.client.core.history.resolve(n2), await this.onRelayEventResponse({ topic: t, payload: n2, transportType: i3 }), this.client.core.history.delete(t, n2.id)) : (this.client.logger.error(`onRelayMessage() -> unknown payload: ${JSON.stringify(n2)}`), await this.onRelayEventUnknownPayload({ topic: t, payload: n2, transportType: i3 })), await this.client.core.relayer.messages.ack(t, e);
    } catch (n2) {
      this.client.logger.error(`onRelayMessage() -> failed to process an inbound message: ${e}`), this.client.logger.error(n2);
    }
  }
  registerExpirerEvents() {
    this.client.core.expirer.on(P2.expired, async (a2) => {
      const { topic: t, id: e } = qn(a2.target);
  ...
  isValidPairingTopic(a2) {
    ...
    if (Bn(this.client.core.pairing.pairings.get(a2).expiry)) {
  ...
  async isValidSessionTopic(a2) {
    ...
    if (Bn(this.client.session.get(a2).expiry)) {
  ...
  async isValidProposalId(a2) {
    ...
    if (Bn(this.client.proposal.get(a2).expiryTimestamp)) {
...
var Rs = class extends ve2 {
  constructor(a2, t) {
    super(a2, t, tt2, _e2), this.core = a2, this.logger = t;
  }
};
var dt3 = class extends ve2 {
  constructor(a2, t) {
...
var Is = class extends ve2 {
  constructor(a2, t) {
    super(a2, t, nt2, _e2, (e) => e.id), this.core = a2, this.logger = t;
  }
};
var Ts = class extends ve2 {
  constructor(a2, t) {
    super(a2, t, lt4, ue2, () => $2), this.core = a2, this.logger = t;
  }
};
var qs = class extends ve2 {
  constructor(a2, t) {
    super(a2, t, pt3, ue2), this.core = a2, this.logger = t;
  }
};
var vs = class extends ve2 {
  constructor(a2, t) {
    super(a2, t, ht, ue2, (e) => e.id), this.core = a2, this.logger = t;
  }
};
var Ps = class {
  constructor(a2, t) {
    this.core = a2, this.logger = t, this.authKeys = new Ts(this.core, this.logger), this.pairingTopics = new qs(this.core, this.logger), this.requests = new vs(this.core, this.logger);
  }
  async init() {
    await this.authKeys.init(), await this.pairingTopics.init(), await this.requests.init();
  }
};
var ut3 = class gt3 extends S2 {
  constructor(a2) {
    ...
    }, this.name = a2?.name || fe3.name, this.metadata = Rn(a2?.metadata), this.signConfig = a2?.signConfig;
    const t = bo({ logger: a2?.logger || fe3.logger, name: this.name });
    this.logger = t, this.core = a2?.core || new Ji(a2), this.session = new dt3(this.core, this.logger), this.proposal = new Rs(this.core, this.logger), this.pendingRequest = new Is(this.core, this.logger), this.engine = new Es(this), this.auth = new Ps(this.core, this.logger);
  }
...
var v5 = `${se3}@2:${H3}:`;
var D3 = "https://rpc.walletconnect.org/v1/";
var j2 = "generic";
var ie3 = `${D3}bundler`;
var d2 = "call_status";
var ne3 = 86400;
...
function F3(i3, e, t) {
  const s = ae(i3);
  return e.rpcMap?.[s.reference] || `${D3}?chainId=${s.namespace}:${s.reference}&projectId=${t}`;
}
function ae3(i3) {
...
var M4 = (i3) => Object.keys(i3).filter((e) => ce2.includes(e)).reduce((e, t) => (e[t] = pe3(i3[t]), e), {});
...
async function me2({ sendCalls: i3, storage: e }) {
  ...
  await e.setItem(d2, { ...t, [i3.result.id]: { request: i3.request, result: i3.result, expiry: Hn(ne3) } });
}
async function ge3({ resultId: i3, storage: e }) {
  const t = await e.getItem(d2);
  if (t) {
    delete t[i3], await e.setItem(d2, t);
    for (const s in t) Bn(t[s].expiry) && delete t[s];
    await e.setItem(d2, t);
  }
}
async function fe4({ resultId: i3, storage: e }) {
  const t = (await e.getItem(d2))?.[i3];
  if (t && !Bn(t.expiry)) return t;
  await ge3({ resultId: i3, storage: e });
}
var ve3 = class {
  constructor(e) {
    this.name = "eip155", this.namespace = e.namespace, this.events = u2("events"), this.client = u2("client"), this.httpProviders = this.createHttpProviders(), this.chainId = parseInt(this.getDefaultChain()), this.storage = $3.getStorage(this.client.core.storage);
  }
  async request(e) {
...
var J2 = class B2 {
  constructor(e) {
    this.events = new import_events5.default(), this.rpcProviders = {}, this.disableProviderPing = false, this.providerOpts = e, this.logger = bo({ logger: e.logger ?? R2, name: this.providerOpts.name ?? H3 }), this.disableProviderPing = e?.disableProviderPing || false;
  }
  static async init(e) {
    const t = new B2(e);
    return await t.initialize(), t;
...
var W3 = async () => {
  const { createAppKit: i3 } = await import("./core-KGJSOPI6.js");
  return i3;
};
function g3(i3) {
...
var E3 = class b3 {
  ...
  async connect(t) {
    ...
    try {
      ...
      if (!n2) return;
      const a2 = wn(n2.namespaces, [this.namespace]);
...
function q3(i3) {
  ...
  const e = t.find((n2) => n2.id === i3.defaultChain?.id), s = { projectId: i3.projectId, networks: t, themeMode: i3.themeMode, themeVariables: $4(i3.themeVariables), chainImages: i3.chainImages, connectorImages: i3.walletImages, defaultNetwork: e, metadata: { ...i3.metadata, name: i3.metadata?.name || "WalletConnect", description: i3.metadata?.description || "Connect to WalletConnect-compatible wallets", url: i3.metadata?.url || "https://walletconnect.org", icons: i3.metadata?.icons || ["https://walletconnect.org/walletconnect-logo.png"] }, showWallets: true, featuredWalletIds: i3.explorerRecommendedWalletIds === "NONE" ? [] : Array.isArray(i3.explorerRecommendedWalletIds) ? i3.explorerRecommendedWalletIds : [], excludeWalletIds: i3.explorerExcludedWalletIds === "ALL" ? [] : Array.isArray(i3.explorerExcludedWalletIds) ? i3.explorerExcludedWalletIds : [], enableEIP6963: false, enableInjected: false, enableCoinbase: true, enableWalletConnect: true, features: { email: false, socials: false } };
...
export {
  N2 as EthereumProvider,
  v6 as OPTIONAL_EVENTS,
  f3 as OPTIONAL_METHODS,
